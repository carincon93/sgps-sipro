...
class ProyectoLinea65 extends Model
{
    use HasFactory;
     ...
     * @return void
     */
    public function scopeFilterProyectoLinea65($query, array $filters)
    {
    ...
    public static function getProyectosPorRol($convocatoria)
    {
        ...
        $proyectos_linea_65 = ProyectoLinea65::select('cultura_innovacion.id', 'cultura_innovacion.titulo', 'cultura_innovacion.fecha_inicio', 'cultura_innovacion.fecha_finalizacion')
            ...
            ->filterProyectoLinea65(request()->only('search'))->paginate();
