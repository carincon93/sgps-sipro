...
class ProyectoFormulario7Linea23 extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'proyectos_formulario_7_linea_23';
     ...
     * @return void
     */
    public function scopeFilterProyectoFormulario7Linea23($query, array $filters)
    {
        $query->when($filters['search'] ?? null, function ($query, $search) {
            ...
            if (is_numeric($search)) {
                $query->orWhere('proyectos_formulario_7_linea_23.id', $search - 8000);
            }
        });
    }
    ...
    public static function getProyectosPorRol($convocatoria)
    {
        ...
        $proyectos_formulario_7_linea_23 = ProyectoFormulario7Linea23::select('proyectos_formulario_7_linea_23.id', 'proyectos_formulario_7_linea_23.titulo', 'proyectos_formulario_7_linea_23.fecha_inicio', 'proyectos_formulario_7_linea_23.fecha_finalizacion')
            ->join('proyectos', 'proyectos_formulario_7_linea_23.id', 'proyectos.id')
            ->whereHas(
                ...
                function ($query) use ($convocatoria, $auth_user) {
                    if ($auth_user->hasRole([2]) && !$auth_user->hasRole([1])) {
                        ...
                        $query->join('proyectos', 'proyectos_formulario_7_linea_23.id', 'proyectos.id');
            ...
            ->distinct('proyectos_formulario_7_linea_23.id')
            ->orderBy('proyectos_formulario_7_linea_23.id', 'ASC')
            ->filterProyectoFormulario7Linea23(request()->only('search'))->paginate();

        $proyectos_formulario_7_linea_23->load('proyecto.evaluaciones', 'proyecto.tipoFormularioConvocatoria.tiposFormularioConvocatoria');

        return $proyectos_formulario_7_linea_23;
    }
}
