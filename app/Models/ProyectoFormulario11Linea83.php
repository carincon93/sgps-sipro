...
class ProyectoFormulario11Linea83 extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'proyectos_formulario_11_linea_83';
     ...
     * @return void
     */
    public function scopeFilterProyectoFormulario11Linea83($query, array $filters)
    {
        $query->when($filters['search'] ?? null, function ($query, $search) {
            ...
            if (is_numeric($search)) {
                $query->orWhere('proyectos_formulario_11_linea_83.id', $search - 8000);
            }
        });
    }
    ...
    public static function getProyectosPorRol($convocatoria)
    {
        ...
        $proyectos_formulario_11_linea_83 = ProyectoFormulario11Linea83::select('proyectos_formulario_11_linea_83.id', 'proyectos_formulario_11_linea_83.titulo', 'proyectos_formulario_11_linea_83.fecha_inicio', 'proyectos_formulario_11_linea_83.fecha_finalizacion')
            ->join('proyectos', 'proyectos_formulario_11_linea_83.id', 'proyectos.id')
            ...
            ->whereHas(
                ...
                function ($query) use ($convocatoria, $auth_user) {
                    ...
                    if ($auth_user->hasRole([2]) && !$auth_user->hasRole([1])) {
                        ...
                        $query->join('proyectos', 'proyectos_formulario_11_linea_83.id', 'proyectos.id');
