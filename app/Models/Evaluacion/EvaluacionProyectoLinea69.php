...
class EvaluacionProyectoLinea69 extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'evaluaciones_proyectos_linea_69';
     ...
     * @return void
     */
    public function scopeFilterEvaluacionProyectoLinea69($query, array $filters)
    {
