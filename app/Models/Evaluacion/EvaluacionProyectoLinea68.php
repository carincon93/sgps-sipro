...
class EvaluacionProyectoLinea68 extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'evaluaciones_proyectos_linea_68';
     ...
     * @return void
     */
    public function scopeFilterEvaluacionProyectoLinea68($query, array $filters)
    {
