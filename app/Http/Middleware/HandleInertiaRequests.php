...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        return array_merge(parent::share($request), [
            ...
            'auth' => [
                'user'                  => $request->user() ? $request->user()->only('id', 'nombre', 'nombre_usuario', 'email', 'roles', 'can', 'can_by_user', 'informacion_completa', 'check_soportes_titulo_obtenido', 'check_certificados_formacion', 'centro_formacion_id', 'regional_id') : null,
