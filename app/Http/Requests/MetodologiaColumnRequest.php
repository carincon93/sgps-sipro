...
class MetodologiaColumnRequest extends FormRequest
{
    ...
    private $columnsRules = [
        ...
        'talento_otros_departamentos'                           => ['nullable', 'array'],
        'areas_cualificacion_mnc'                               => ['nullable', 'array'],
        'talentos_otros_departamentos'                          => ['nullable', 'array'],
        'acciones_mejoramiento_idic'                            => ['nullable', 'string'],
        'municipios_beneficiados_vigencia_anterior'             => ['nullable', 'array'],
        'beneficio_municipios_vigencia_anterior'                => ['nullable', 'string'],
        'municipios_beneficiados_vigencia_actual'               => ['nullable', 'array'],
