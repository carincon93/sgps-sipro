...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'numero_documento'                      => ['required', 'min:0', 'min:0', 'max:9223372036854775807', 'integer', 'unique:users,numero_documento,' . $this->route('user')->id . ',id'],
            'lugar_expedicion_id'                   => ['required', 'min:0', 'min:0', 'max:2147483647', 'integer', 'exists:municipios,id'],
            'numero_celular'                        => ['required', 'min:0', 'min:0', 'max:9223372036854775807', 'integer'],
