...
class UpdateUserRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'habilitado'                            => true,
            'cursos_de_evaluacion_realizados'       => $this->cursos_de_evaluacion_realizados ? json_encode($this->cursos_de_evaluacion_realizados) : null,
            'tiempo_por_rol'                        => $this->tiempo_por_rol ? json_encode($this->tiempo_por_rol) : null,
            'roles_fuera_sennova'                   => $this->roles_fuera_sennova ? json_encode($this->roles_fuera_sennova) : null,
            'otros_roles_sennova'                   => $this->otros_roles_sennova ? json_encode($this->otros_roles_sennova) : null,
            'disciplinas_subarea_conocimiento'      => $this->disciplinas_subarea_conocimiento ? json_encode($this->disciplinas_subarea_conocimiento) : null,
