    ...
    public function rules()
    {
        if ($this->isMethod('PUT')) {
            return [
                ...
                'area_conocimiento_id'                          => ['nullable', 'min:0', 'max:2147483647', 'integer', 'exists:areas_conocimiento,id'],
                'disciplina_subarea_conocimiento_id'            => ['nullable', 'min:0', 'max:2147483647', 'integer', 'exists:disciplinas_subarea_conocimiento,id'],
