...
class ProyectoController extends Controller
{
    ...
    public function resumenFinal(Convocatoria $convocatoria, Proyecto $proyecto)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/ResumenFinal', [
            ...
            'topes_roles_sennova_formulario_15'     => $proyecto->proyectoFormulario15Linea65()->exists() ? ProyectoRolSennovaValidationTrait::topesRolesSennovaFormulario15Validation($convocatoria, $proyecto) : null,
            'topes_roles_sennova_formulario_16'     => $proyecto->proyectoFormulario16Linea65()->exists() ? ProyectoRolSennovaValidationTrait::topesRolesSennovaFormulario16Validation($convocatoria, $proyecto) : null,
