...
class ProyectoFormulario7Linea23Controller extends Controller
{
    ...
    public function store(ProyectoFormulario7Linea23Request $request, Convocatoria $convocatoria)
    {
        ...
        $proyecto_formulario_7_linea_23->muestreo                                          = 6;
        $proyecto_formulario_7_linea_23->actividades_muestreo                              = null;
        $proyecto_formulario_7_linea_23->objetivo_muestreo                                 = null;
        $proyecto_formulario_7_linea_23->recoleccion_especimenes                           = 2;
        ...
        $proyecto->proyectoFormulario8Linea82()->save($proyecto_formulario_7_linea_23);
        ...
        return redirect()->route('convocatorias.proyectos-formulario-8-linea-66.edit', [$convocatoria, $proyecto_formulario_7_linea_23])->with('success', 'El recurso se ha creado correctamente. Por favor continue diligenciando la información.');
    }
    ...
    public function edit(Convocatoria $convocatoria, ProyectoFormulario7Linea23 $proyecto_formulario_7_linea_23)
    {
        ...
        $proyecto_formulario_7_linea_23->mesasSectoriales;
        $proyecto_formulario_7_linea_23->areasTematicasEni;
        $proyecto_formulario_7_linea_23->lineasInvestigacionEni;
    ...
    public function update(ProyectoFormulario7Linea23Request $request, Convocatoria $convocatoria, ProyectoFormulario7Linea23 $proyecto_formulario_7_linea_23)
    {
        ...
        $proyecto_formulario_7_linea_23->fecha_finalizacion                              = $request->fecha_finalizacion;
        $proyecto_formulario_7_linea_23->max_meses_ejecucion                             = $request->max_meses_ejecucion;
        $proyecto_formulario_7_linea_23->video                                           = $request->video;
        $proyecto_formulario_7_linea_23->numero_aprendices                               = $request->numero_aprendices;

        $proyecto_formulario_7_linea_23->resumen                                         = $request->resumen;
        $proyecto_formulario_7_linea_23->antecedentes                                    = $request->antecedentes;
        $proyecto_formulario_7_linea_23->marco_conceptual                                = $request->marco_conceptual;
        $proyecto_formulario_7_linea_23->justificacion_industria_4                       = $request->justificacion_industria_4;
        $proyecto_formulario_7_linea_23->justificacion_economia_naranja                  = $request->justificacion_economia_naranja;
        $proyecto_formulario_7_linea_23->justificacion_politica_discapacidad             = $request->justificacion_politica_discapacidad;
        $proyecto_formulario_7_linea_23->atencion_pluralista_diferencial                 = $request->atencion_pluralista_diferencial;
        $proyecto_formulario_7_linea_23->impacto_sector_agricola                         = $request->impacto_sector_agricola;
        $proyecto_formulario_7_linea_23->bibliografia                                    = $request->bibliografia;
        $proyecto_formulario_7_linea_23->impacto_municipios                              = $request->impacto_municipios;
        $proyecto_formulario_7_linea_23->impacto_centro_formacion                        = $request->impacto_centro_formacion;

        $proyecto_formulario_7_linea_23->muestreo                                        = $request->muestreo;
        $proyecto_formulario_7_linea_23->actividades_muestreo                            = $request->muestreo == 1 ? $request->actividades_muestreo : null;
        $proyecto_formulario_7_linea_23->objetivo_muestreo                               = $request->muestreo == 1 ? $request->objetivo_muestreo  : null;
        $proyecto_formulario_7_linea_23->recoleccion_especimenes                         = $request->recoleccion_especimenes;

        $proyecto_formulario_7_linea_23->relacionado_plan_tecnologico                    = $request->relacionado_plan_tecnologico;
        ...
        $proyecto_formulario_7_linea_23->justificacion_relacion_campesena                = $request->justificacion_relacion_campesena;
        $proyecto_formulario_7_linea_23->lineas_estrategicas_convocatoria                = $request->lineas_estrategicas_convocatoria;
        $proyecto_formulario_7_linea_23->justificacion_lineas_estrategicas               = $request->justificacion_lineas_estrategicas;
        $proyecto_formulario_7_linea_23->impacto_regional                                = $request->impacto_regional;
        $proyecto_formulario_7_linea_23->justificacion_impacto_regional                  = $request->justificacion_impacto_regional;
        $proyecto_formulario_7_linea_23->justificacion_mesas_sectoriales                 = $request->justificacion_mesas_sectoriales;
        $proyecto_formulario_7_linea_23->areas_cualificacion_mnc                         = $request->areas_cualificacion_mnc;
        ...
        $proyecto_formulario_7_linea_23->veredas_corregimientos                          = $request->veredas_corregimientos;
    ...
    public function updateEvaluacion(EvaluacionProyectoFormulario7Linea23Request $request, Convocatoria $convocatoria, EvaluacionProyectoFormulario7Linea23 $evaluacion_proyecto_linea66)
    {
    ...
    public function updateLongColumn(ProyectoFormulario7Linea23ColumnRequest $request, Convocatoria $convocatoria, ProyectoFormulario7Linea23 $proyecto_formulario_7_linea_23, $column)
    {
        ...
        if ($column == 'mesa_sectorial_id') {
            $proyecto_formulario_7_linea_23->mesasSectoriales()->sync($request->only($column)[$column]);
            return back();
        }
