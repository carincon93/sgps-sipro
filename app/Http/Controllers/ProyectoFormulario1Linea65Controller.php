...
class ProyectoFormulario1Linea65Controller extends Controller
{
    ...
    public function edit(Convocatoria $convocatoria, ProyectoFormulario1Linea65 $proyecto_formulario_1_linea_65)
    {
        ...
        if (request()->filled('evaluacion_id')) {
            ...
            $items_evaluacion = $evaluacion->getItemsAEvaluar($convocatoria->id, $proyecto_formulario_1_linea_65->proyecto->tipo_formulario_convocatoria_id);
        }

        $proyecto_formulario_1_linea_65->load('proyecto.evaluaciones.evaluacionesProyectoFormulario1Linea65', 'proyecto.proyectoRolesSennova.proyectoRolesEvaluaciones', 'proyecto.proyectoPresupuesto.proyectoPresupuestosEvaluaciones');
    ...
    public function updateEvaluacion(EvaluacionProyectoFormulario1Linea65Request $request, Convocatoria $convocatoria)
    {
        ...
        foreach ($items_evaluacion_filtrados as $item) {
            ...
            EvaluacionProyectoFormulario1Linea65::updateOrCreate(
                [
