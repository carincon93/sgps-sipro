...
class ProyectoFormulario13Linea65Controller extends Controller
{
    ...
    public function edit(Convocatoria $convocatoria, ProyectoFormulario13Linea65 $proyecto_formulario_13_linea_65)
    {
        ...
        $proyecto_formulario_13_linea_65->load('proyecto.evaluaciones.evaluacionesProyectoFormulario1Linea65', 'proyecto.proyectoRolesSennova.proyectoRolesEvaluaciones', 'proyecto.proyectoPresupuesto.proyectoPresupuestosEvaluaciones');
