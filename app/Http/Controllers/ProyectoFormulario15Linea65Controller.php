...
class ProyectoFormulario15Linea65Controller extends Controller
{
    ...
    public function edit(Convocatoria $convocatoria, ProyectoFormulario15Linea65 $proyecto_formulario_15_linea_65)
    {
        ...
        return Inertia::render('Convocatorias/Proyectos/ProyectosFormulario15Linea65/Edit', [
            ...
            'programas_formacion_con_registro_calificado'   => SelectHelper::programasFormacion()->where('registro_calificado', true)->where('centro_formacion_id', $proyecto_formulario_15_linea_65->proyecto->centro_formacion_id)->values()->all(),
    ...
    public function update(ProyectoFormulario15Linea65Request $request, Convocatoria $convocatoria, ProyectoFormulario15Linea65 $proyecto_formulario_15_linea_65)
    {
        ...
        $proyecto_formulario_15_linea_65->fecha_finalizacion                        = $request->fecha_finalizacion;
        $proyecto_formulario_15_linea_65->max_meses_ejecucion                       = $request->max_meses_ejecucion;
        $proyecto_formulario_15_linea_65->video                                     = $request->video;
        $proyecto_formulario_15_linea_65->numero_aprendices                         = $request->numero_aprendices;

        $proyecto_formulario_15_linea_65->resumen                                   = $request->resumen;
        $proyecto_formulario_15_linea_65->antecedentes                              = $request->antecedentes;
        $proyecto_formulario_15_linea_65->marco_conceptual                          = $request->marco_conceptual;
        $proyecto_formulario_15_linea_65->justificacion_industria_4                 = $request->justificacion_industria_4;
        $proyecto_formulario_15_linea_65->justificacion_politica_discapacidad       = $request->justificacion_politica_discapacidad;
        $proyecto_formulario_15_linea_65->impacto_municipios                        = $request->impacto_municipios;
        $proyecto_formulario_15_linea_65->impacto_centro_formacion                  = $request->impacto_centro_formacion;
        $proyecto_formulario_15_linea_65->bibliografia                              = $request->bibliografia;
        $proyecto_formulario_15_linea_65->atencion_pluralista_diferencial           = $request->atencion_pluralista_diferencial;

        $proyecto_formulario_15_linea_65->relacionado_plan_tecnologico              = $request->relacionado_plan_tecnologico;
        $proyecto_formulario_15_linea_65->relacionado_agendas_competitividad        = $request->relacionado_agendas_competitividad;
        $proyecto_formulario_15_linea_65->relacionado_mesas_sectoriales             = $request->relacionado_mesas_sectoriales;

        $proyecto_formulario_15_linea_65->eje_sennova                               = $request->eje_sennova;
        $proyecto_formulario_15_linea_65->areas_cualificacion_mnc                   = $request->areas_cualificacion_mnc;
        $proyecto_formulario_15_linea_65->aportacion_linea_transeversal_campesena   = $request->aportacion_linea_transeversal_campesena;
        $proyecto_formulario_15_linea_65->lineas_estrategicas_sena                  = $request->lineas_estrategicas_sena;
        $proyecto_formulario_15_linea_65->justificacion_aportes_lineas_estrategicas = $request->justificacion_aportes_lineas_estrategicas;
        $proyecto_formulario_15_linea_65->lineas_programaticas_sennova              = $request->lineas_programaticas_sennova;
    ...
    public function updateEvaluacion(EvaluacionProyectoFormulario15Linea65Request $request, Convocatoria $convocatoria, EvaluacionProyectoFormulario15Linea65 $evaluacion_proyecto_formulario_15_linea_65)
    {
        $this->authorize('modificar-evaluacion-autor', $evaluacion_proyecto_formulario_15_linea_65->evaluacion);

        $evaluacion_proyecto_formulario_15_linea_65->evaluacion()->update([
            'iniciado' => true,
            'clausula_confidencialidad' => $request->clausula_confidencialidad

        ]);

        $evaluacion_proyecto_formulario_15_linea_65->titulo_puntaje                                      = $request->titulo_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->titulo_comentario                                   = $request->titulo_requiere_comentario == false ? $request->titulo_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->video_puntaje                                       = $request->video_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->video_comentario                                    = $request->video_requiere_comentario == false ? $request->video_comentario : null;

        $evaluacion_proyecto_formulario_15_linea_65->antecedentes_puntaje                                = $request->antecedentes_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->antecedentes_comentario                             = $request->antecedentes_requiere_comentario == false ? $request->antecedentes_comentario : null;

        $evaluacion_proyecto_formulario_15_linea_65->resumen_puntaje                                     = $request->resumen_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->resumen_comentario                                  = $request->resumen_requiere_comentario == false ? $request->resumen_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->ortografia_puntaje                                  = $request->ortografia_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->ortografia_comentario                               = $request->ortografia_requiere_comentario == false ? $request->ortografia_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->redaccion_puntaje                                   = $request->redaccion_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->redaccion_comentario                                = $request->redaccion_requiere_comentario == false ? $request->redaccion_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->normas_apa_puntaje                                  = $request->normas_apa_puntaje;
        $evaluacion_proyecto_formulario_15_linea_65->normas_apa_comentario                               = $request->normas_apa_requiere_comentario == false ? $request->normas_apa_comentario : null;

        $evaluacion_proyecto_formulario_15_linea_65->justificacion_economia_naranja_comentario           = $request->justificacion_economia_naranja_requiere_comentario == false ? $request->justificacion_economia_naranja_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->justificacion_industria_4_comentario                = $request->justificacion_industria_4_requiere_comentario == false ? $request->justificacion_industria_4_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->bibliografia_comentario                             = $request->bibliografia_requiere_comentario == false ? $request->bibliografia_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->fechas_comentario                                   = $request->fechas_requiere_comentario == false ? $request->fechas_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->justificacion_politica_discapacidad_comentario      = $request->justificacion_politica_discapacidad_requiere_comentario == false ? $request->justificacion_politica_discapacidad_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->actividad_economica_comentario                      = $request->actividad_economica_requiere_comentario == false ? $request->actividad_economica_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->area_conocimiento_comentario                        = $request->area_conocimiento_requiere_comentario == false ? $request->area_conocimiento_comentario : null;
        $evaluacion_proyecto_formulario_15_linea_65->tematica_estrategica_comentario                     = $request->tematica_estrategica_requiere_comentario == false ? $request->tematica_estrategica_comentario : null;

        $evaluacion_proyecto_formulario_15_linea_65->save();
