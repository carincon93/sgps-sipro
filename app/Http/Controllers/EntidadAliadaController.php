...
class EntidadAliadaController extends Controller
{
    ...
    public function update(EntidadAliadaRequest $request, Convocatoria $convocatoria, Proyecto $proyecto, EntidadAliada $entidad_aliada)
    {
        ...
        switch ($proyecto->tipo_formulario_convocatoria_id) {
            ...
            case 6:
                ...
                $entidad_aliada_linea_66_82 = $entidad_aliada->entidadAliadaLinea66_82()->update($request->only('descripcion_convenio', 'grupo_investigacion', 'codigo_gruplac', 'enlace_gruplac', 'actividades_transferencia_conocimiento', 'recursos_especie', 'descripcion_recursos_especie', 'recursos_dinero', 'descripcion_recursos_dinero'));
    ...
    {
        $modelo = $entidad_aliada->entidadAliadaLinea66_82;
    ...
    public function downloadServerFile(Request $request, Convocatoria $convocatoria, Proyecto $proyecto, EntidadAliada $entidad_aliada)
    {
        if ($entidad_aliada->entidadAliadaLinea66_82()->exists()) {
            $entidad_aliada->entidadAliadaLinea66_82->ruta_final_sharepoint = $proyecto->centroFormacion->nombre_carpeta_sharepoint . '/' . $proyecto->tipoFormularioConvocatoria->lineaProgramatica->codigo . '/' . $proyecto->codigo . '/ENTIDADES ALIADAS';
            SharepointHelper::downloadServerFile($entidad_aliada->entidadAliadaLinea66_82, $request->formato);
    ...
    public function downloadFileSharepoint(Convocatoria $convocatoria, Proyecto $proyecto, EntidadAliada $entidad_aliada, $tipo_archivo)
    {
        $sharepoint_path = '';
        if ($entidad_aliada->entidadAliadaLinea66_82()->exists()) {
            $sharepoint_path = $entidad_aliada->entidadAliadaLinea66_82[$tipo_archivo];
        } else if ($entidad_aliada->entidadAliadaLinea69()->exists()) {
