...
class ProyectoFormulario16Linea65Controller extends Controller
{
    ...
    public function edit(Convocatoria $convocatoria, ProyectoFormulario16Linea65 $proyecto_formulario_16_linea_65)
    {
        ...
        $proyecto_formulario_16_linea_65->load('proyecto.evaluaciones.evaluacionesProyectoFormulario1Linea65', 'proyecto.proyectoRolesSennova.proyectoRolesEvaluaciones', 'proyecto.proyectoPresupuesto.proyectoPresupuestosEvaluaciones');
        ...
        $proyecto_formulario_16_linea_65->proyecto->tipoFormularioConvocatoria->tiposFormularioConvocatoria;
    ...
    public function updateEvaluacion(EvaluacionProyectoFormulario16Linea65Request $request, Convocatoria $convocatoria)
    {
        $evaluacion = Evaluacion::find($request->evaluacion_id);
        ...
        foreach ($items_evaluacion_filtrados as $item) {
            ...
            EvaluacionProyectoFormulario16Linea65::updateOrCreate(
                [
