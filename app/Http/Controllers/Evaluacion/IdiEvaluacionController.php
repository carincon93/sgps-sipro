...
class IdiEvaluacionController extends Controller
{
    ...
    public function edit(Convocatoria $convocatoria, IdiEvaluacion $idiEvaluacion)
    {
        ...
        return Inertia::render('Convocatorias/Evaluaciones/Idi/Edit', [
            'convocatoria'                              => $convocatoria->only('id', 'esta_activa', 'fase_formateada', 'fase', 'tipo_convocatoria', 'min_fecha_inicio_proyectos_idi', 'max_fecha_finalizacion_proyectos_idi', 'campos_convocatoria', 'year'),
            'idi'                                       => $idi,
            ...
            'programasFormacionConRegistroCalificado'   => SelectHelper::programasFormacion()->where('programas_formacion.registro_calificado', true)->where('programas_formacion.centro_formacion_id', $idi->proyecto->centro_formacion_id)->values()->all(),
            'programasFormacionSinRegistroCalificado'   => SelectHelper::programasFormacion()->where('programas_formacion.registro_calificado', false)->values()->all(),
            ...
            'programasFormacionConRegistroRelacionados' => $idi->proyecto->programasFormacion()->selectRaw('programas_formacion.id as value, concat(programas_formacion.nombre, chr(10), \'∙ Código: \', programas_formacion.codigo) as label')->where('programas_formacion.registro_calificado', true)->get(),
            'programasFormacionSinRegistroRelacionados' => $idi->proyecto->programasFormacion()->selectRaw('programas_formacion.id as value, concat(programas_formacion.nombre, chr(10), \'∙ Código: \', programas_formacion.codigo) as label')->where('programas_formacion.registro_calificado', false)->get(),
            'lineasTecnoacademia'                       => SelectHelper::lineasTecnoacademia(),
            'lineasInvestigacion'                       => SelectHelper::lineasInvestigacion()->where('lineas_investigacion.centro_formacion_id', $idi->proyecto->centro_formacion_id)->values()->all(),
            'gruposInvestigacion'                       => SelectHelper::gruposInvestigacion()->where('lineas_investigacion.value', 126)->values()->all(),
            'areasTematicasEni'                         => SelectHelper::areasTematicasEni(),
            'lineasInvestigacionEni'                    => SelectHelper::lineasInvestigacion()->where('lineas_investigacion.grupo_investigacion_id', 126)->values()->all(),
