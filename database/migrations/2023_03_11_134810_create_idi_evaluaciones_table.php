...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('idi_evaluaciones', function (Blueprint $table) {
            ...
            $table->text('disciplina_subarea_conocimiento_comentario')->nullable();
            $table->text('red_conocimiento_comentario')->nullable();
            $table->text('tematica_estrategica_comentario')->nullable();
            $table->boolean('entidad_aliada_verificada')->nullable()->default(false);
            $table->text('impacto_sector_agricola')->nullable();
            $table->text('impacto_poblacion_campesina')->nullable();
    ...
    {
        Schema::dropIfExists('idi_evaluaciones');
    }
};
