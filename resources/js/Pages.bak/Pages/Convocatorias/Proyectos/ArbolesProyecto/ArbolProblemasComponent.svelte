    ...
    <div class="efecto-directo-container">
        <div class="p-2">
            <div class="text-5xl font-extrabold my-10">
                <span class="bg-clip-text text-transparent m-auto bg-gradient-to-r from-app-500 to-app-300 block w-max">1. Problema central </span>
            </div>

            <form on:submit|preventDefault={submitProblemaCentral} id="problema-central">
                <fieldset class="space-y-20" disabled={proyecto.allowed.to_update ? undefined : true}>
                    ...
                    <div class="text-5xl font-extrabold my-10">
                        <span class="bg-clip-text text-transparent m-auto bg-gradient-to-r from-app-500 to-app-300 block w-max">2. Objetivo general </span>
                    </div>
                ...
                {#if proyecto.allowed.to_update}
                    <LoadingButton loading={$formProblemaCentral.processing} class="my-10" type="submit" form="problema-central">1. Guardar información sobre el problema central</LoadingButton>
                {/if}
            </form>
        </div>
    </div>
