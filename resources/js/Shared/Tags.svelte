<script>
    ...
    $: props = {
        ...$$restProps,
        class: `tagify-input bg-white w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 focus:border-app-200 focus:ring-app-200 ${$$restProps.class || ''}`,
    }
</script>
