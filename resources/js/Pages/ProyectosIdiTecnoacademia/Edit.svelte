        ...
        <div class="flex items-center justify-between lg:px-8 max-w-7xl mx-auto px-4 py-6 sm:px-6">
            <div>
                <h1>
                    ...
                    <a use:inertia href={route('proyectos-idi-tecnoacademia.edit', proyectoIdiTecnoacademia.id)} class="text-app-400 hover:text-app-600 font-extrabold underline"> Información básica </a>
                    <span class="text-app-400 font-medium">/</span>
