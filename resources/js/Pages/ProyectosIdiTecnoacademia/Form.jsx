    ...
    <fieldset className="p-8" disabled={proyectoIdiTecnoacademia?.allowed.to_update || allowed_to_create ? undefined : true}>
        ...
        {#if $form.tecnoacademia_id && arrayLineasTecnoacademia}
            <div className="mt-44 grid grid-cols-2">
                ...
                <div>
                    <MultipleSelect id="tecnoacademia_linea_tecnoacademia_id" bind:selectedValue={$form.tecnoacademia_linea_tecnoacademia_id} items={arrayLineasTecnoacademia}  error={errors.tecnoacademia_linea_tecnoacademia_id} placeholder="Buscar por el nombre de la línea" required />
                </div>
            </div>
        {/if}
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="palabras_clave" value="Palabras claves relacionadas con el proyecto (Separados por coma)" />
            </div>
            <div>
                <Tags id="palabras_clave" className="mt-4" enforceWhitelist={false} bind:tags={$form.palabras_clave} placeholder="Palabras clave" error={errors.palabras_clave} required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label className="mb-4" labelFor="especies" value="En caso de aplicar, por favor incluir las especies (nombre científico) que hacen parte del proyecto" />
            </div>
            <div>
                <Tags id="especies" className="mt-4" enforceWhitelist={false} bind:tags={$form.especies} placeholder="Especies" error={errors.especies} />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label className="mb-4" value="¿El proyecto hace parte de una línea de investigación de la TecnoAcademia?" />
            </div>
            <div>
        ...
        {#if $form.tiene_linea_investigacion}
            <div className="mt-44 grid grid-cols-2">
                <div>
                    <Label required className="mb-4" labelFor="lineas_investigacion" value="¿Cuáles líneas de investigación hacen parte del proyecto? (Separar por coma)" />
                </div>
                <div>
                    <Tags id="lineas_investigacion" className="mt-4" enforceWhitelist={false} bind:tags={$form.lineas_investigacion} placeholder="Líneas de investigación" error={errors.lineas_investigacion} required />
                </div>
            </div>
        {/if}
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label className="mb-4" value="¿Es un proyecto nuevo?" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label className="mb-4" value="¿Es un proyecto que genera continuidad de uno anterior?" />
            </div>
            <div>
        ...
        {#if $form.proyecto_con_continuidad}
            <div className="mt-44 grid grid-cols-1">
                <div>
                    <Label required className="mb-4" labelFor="productos_premios" value="Si es un proyecto que ha tenido continuidad, por favor relacione los productos obtenidos previamente y los reconocimientos o premios" />
                </div>
                <div>
            ...
            <div className="mt-44 grid grid-cols-2">
                <div>
                    <Label required className="mb-4" labelFor="proyecto_id" value="Seleccione el código SGPS del proyecto" />
                </div>
                <div>
        ...
        <div className="mt-44 grid grid-cols-1">
            <div>
                <Label required className="mb-4" labelFor="texto_exposicion" value="Texto para exposición: Un texto corto que resuma la experiencia y que pueda ser publicado en espacios como el MUSEO SENA para introducir la iniciativa y los resultados." />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="pdf_proyecto" value="Proyecto en documento pdf" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="nombre_aprendices_vinculados" value="Nombre de los aprendices vinculados al proyecto (Por favor separar los nombres por coma- ,)" />
            </div>
            <div>
                <Tags id="nombre_aprendices_vinculados" className="mt-4" enforceWhitelist={false} bind:tags={$form.nombre_aprendices_vinculados} placeholder="Aprendices vinculados" error={errors.nombre_aprendices_vinculados} />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required={$form.nombre_instituciones_educativas ? undefined : true} className="mb-4" labelFor="nombre_instituciones_educativas" value="Nombre de las instituciones educativas de los aprendices vinculados al proyecto" />
            </div>
            <div>
                <Select id="departamento" bind:selectedValue={departamentoIE} items={regionales} placeholder="Seleccione un departamento" />

                <Tags id="nombre_instituciones_educativas" className="mt-4" whitelist={whitelistInstitucionesEducativas} bind:tags={$form.nombre_instituciones_educativas} placeholder="Nombre(s) de la(s) IE" error={errors.nombre_instituciones_educativas} required={$form.nuevas_instituciones_educativas ? undefined : true} />
                <div className="mt-10">
                    ...
                    <Tags id="nuevas_instituciones_educativas" className="mt-4" enforceWhitelist={false} bind:tags={$form.nuevas_instituciones_educativas} placeholder="Instituciones educativas (Separadas por coma)" error={errors.nuevas_instituciones_educativas} />
                </div>
            </div>
        </div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="programa_sennova_participante" value="¿El proyecto vincula otro programa sennova?" />
            </div>
            <div>
                <MultipleSelect id="programa_sennova_participante" bind:selectedValue={$form.programa_sennova_participante} items={programasSennova}  error={errors.programa_sennova_participante} placeholder="Seleccione un programa" required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="nombre_centro_programa" value="Por favor incluya el nombre y centro del programa sennova que participa en el proyecto" />
            </div>
            <div>
                <Input label="Nombre" id="nombre_centro_programa" type="text" className="mt-1" error={errors.nombre_centro_programa} bind:value={$form.nombre_centro_programa} required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="programa_formacion_articulado_media" value="El proyecto está vinculado a un programa de formación de articulación con la media? por favor indicar cual y la institución educativa" />
            </div>
            <div>
                <Input label="Nombre" id="programa_formacion_articulado_media" type="text" className="mt-1" error={errors.programa_formacion_articulado_media} bind:value={$form.programa_formacion_articulado_media} required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label className="mb-4" value="¿Otras organizaciones externas vinculadas al proyecto?" />
            </div>
            <div>
        ...
        {#if hayEntidadesVinculadas}
            <div className="mt-44 grid grid-cols-2">
                <div>
                    <Label required className="mb-4" labelFor="entidades_vinculadas" value="Nombre de las entidades vinculadas al proyecto (Por favor separar los nombres por coma- ,)" />
                </div>
                <div>
                    <Tags id="entidades_vinculadas" className="mt-4" enforceWhitelist={false} bind:tags={$form.entidades_vinculadas} placeholder="Entidades vinculadas" />
                </div>
            </div>
        {/if}
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="fuente_recursos" value="Fuente de recursos para el proyecto" />
            </div>
            <div>
                <Input label="Fuente" id="fuente_recursos" type="text" className="mt-1" error={errors.fuente_recursos} bind:value={$form.fuente_recursos} required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="presupuesto" value="Presupuesto del proyecto por año (o por la duración del proyecto si es menor a un año)" />
            </div>
            <div>
                <Input label="Presupuesto" id="presupuesto" type="number" input$min="0" className="mt-1" error={errors.presupuesto} bind:value={$form.presupuesto} required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="municipios" value="Nombre los municipios en los que se desarrolla" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="semillero_investigacion_id" value="¿Hace parte de un semillero?" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="beneficiados" value="El proyecto beneficiará a" />
            </div>
            <div>
                <MultipleSelect id="beneficiados" bind:selectedValue={$form.beneficiados} items={beneficiados}  error={errors.beneficiados} placeholder="Selecciona los beneficiados" required />
            </div>
        </div>

        <div className="mt-44 grid grid-cols-1">
            <div>
                <Label required className="mb-4" labelFor="poblacion_beneficiada" value="Por favor describa la población que beneficia la iniciativa" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-1">
            <div>
                <Label className="mb-4" labelFor="otra_poblacion_beneficiada" value="Si es OTRA, por favor aclarar cuál" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-1">
            <div>
                <Label required className="mb-4" labelFor="resultados_obtenidos" value="Resultados obtenidos" />
            </div>
            <div>
        ...
        {#if existenDocumentos}
            <div className="mt-44 grid grid-cols-2">
                <div>
                    <Label required className="mb-4" labelFor="documentos_resultados" value="Si, sí, por favor cargar el documento con los resultados. (Si son varios comprímalos en un archivo .zip)" />
                </div>
                <div>
                    <File
        ...
        <div className="mt-44 grid grid-cols-1">
            <div>
                <Label required className="mb-4" labelFor="observaciones_resultados" value="Observaciones" />
            </div>
            <div>
        ...
        <div className="mt-44 grid grid-cols-2">
            <div>
                <Label required className="mb-4" labelFor="rol_sennova" value="Rol" />
            </div>
...
<Dialog bind:open={dialogGuardar}>
    ...
    <div slot="content">
        <Export2Word id="borrador" showButton={false} bind:this={exportComponent}>
            <h1 className="font-black text-center my-10">Información del proyecto I+D+i Tecnoacademia</h1>
