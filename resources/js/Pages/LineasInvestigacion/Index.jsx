            ...
            {#each lineasInvestigacion.data as lineaInvestigacion (lineaInvestigacion.id)}
                <tr className="hover:bg-gray-100 focus-within:bg-gray-100">
                    ...
                    <td className="border-t td-actions">
                        <DataTableMenu className={lineasInvestigacion.data.length < 3 ? 'z-50' : ''}>
                            ...
                            <Separator className={!lineaInvestigacion.allowed.to_destroy ? 'hidden' : ''} />
                            <Item on:SMUI:action={() => ((lineaInvestigacionId = lineaInvestigacion.id), (dialogEliminar = true), (allowedToDestroy = lineaInvestigacion.allowed.to_destroy))} disabled={!lineaInvestigacion.allowed.to_destroy} className={!lineaInvestigacion.allowed.to_destroy ? 'hidden' : ''}>
                                <Text>Eliminar</Text>
                            </Item>
                        </DataTableMenu>
                    </td>
