...
<AuthenticatedLayout>
    ...
    <InfoMessage className="mb-8">
        ...
        <p className="my-8">Se debe evidenciar que la metodología se presente de forma organizada y de manera secuencial, de acuerdo con el ciclo P-H-V-A “Planificar – Hacer – Verificar - Actuar” para alcanzar el objetivo general y cada uno de los objetivos específicos.</p>
    </InfoMessage>
                    ...
                    {#if isSuperAdmin || (evaluacion.finalizado && evaluacion.habilitado)}
                        <div className="bg-zinc-900 p-4 rounded shadow text-white my-2">
                            ...
                            {#if evaluacion.idi_evaluacion}
                                <p className="whitespace-pre-line text-xs">{evaluacion.idi_evaluacion?.metodologia_comentario ? evaluacion.idi_evaluacion.metodologia_comentario : 'Sin recomendación'}</p>
                            {:else if evaluacion.cultura_innovacion_evaluacion}
                                <p className="whitespace-pre-line text-xs">{evaluacion.cultura_innovacion_evaluacion?.metodologia_comentario ? evaluacion.cultura_innovacion_evaluacion.metodologia_comentario : 'Sin recomendación'}</p>
                            {:else if evaluacion.ta_evaluacion}
                                <p className="whitespace-pre-line text-xs">{evaluacion.ta_evaluacion?.metodologia_comentario ? evaluacion.ta_evaluacion.metodologia_comentario : 'Sin recomendación'}</p>
                            {:else if evaluacion.tp_evaluacion}
                                <p className="whitespace-pre-line text-xs">{evaluacion.tp_evaluacion?.metodologia_comentario ? evaluacion.tp_evaluacion.metodologia_comentario : 'Sin recomendación'}</p>
                            {:else if evaluacion.servicio_tecnologico_evaluacion}
                                <h1 className="font-black mt-10">Metodología</h1>

                                <p className="whitespace-pre-line text-xs">{evaluacion.servicio_tecnologico_evaluacion?.metodologia_comentario ? evaluacion.servicio_tecnologico_evaluacion.metodologia_comentario : 'Sin recomendación'}</p>

                                <hr className="mt-10 mb-10 border-black-200" />
                                <h1 className="font-black">Actividades</h1>

                                <ul className="list-disc pl-4">
                                    <li className="whitespace-pre-line text-xs mb-10">{evaluacion.servicio_tecnologico_evaluacion?.actividades_primer_obj_comentario ? 'Recomendación actividades del primer objetivo específico: ' + evaluacion.servicio_tecnologico_evaluacion.actividades_primer_obj_comentario : 'Sin recomendación'}</li>
                                    <li className="whitespace-pre-line text-xs mb-10">{evaluacion.servicio_tecnologico_evaluacion?.actividades_segundo_obj_comentario ? 'Recomendación actividades del segundo objetivo específico: ' + evaluacion.servicio_tecnologico_evaluacion.actividades_segundo_obj_comentario : 'Sin recomendación'}</li>
                                    <li className="whitespace-pre-line text-xs mb-10">{evaluacion.servicio_tecnologico_evaluacion?.actividades_tercer_obj_comentario ? 'Recomendación actividades del tercer objetivo específico: ' + evaluacion.servicio_tecnologico_evaluacion.actividades_tercer_obj_comentario : 'Sin recomendación'}</li>
                                    <li className="whitespace-pre-line text-xs mb-10">{evaluacion.servicio_tecnologico_evaluacion?.actividades_cuarto_obj_comentario ? 'Recomendación actividades del cuarto objetivo específico: ' + evaluacion.servicio_tecnologico_evaluacion.actividades_cuarto_obj_comentario : 'Sin recomendación'}</li>
                                </ul>
                            {/if}
                        </div>
                    {/if}
    ...
    <form on:submit|preventDefault={submit}>
            ...
            {#if proyecto.codigo_linea_programatica == 70}
                <div>
                    <div className="py-24 grid grid-cols-2 gap-4">
                        <div>
                            <Label required className="mb-4" labelFor="implementacion_modelo_pedagogico" value="Implementación del Modelo Pedagógico de las TecnoAcademia en el contexto regional de la TecnoAcademia" />
                        </div>
                        <div>
                ...
                <div className="py-24">
                    ...
                    <div>
                        <MultipleSelect id="municipios" bind:selectedValue={$form.municipios} items={municipios}  error={errors.municipios} placeholder="Buscar municipios" required />
                    </div>
                </div>
                ...
                <div className="py-24">
                    ...
                    <div>
                        <MultipleSelect id="municipios_impactar" bind:selectedValue={$form.municipios_impactar} items={municipios}  error={errors.municipios_impactar} placeholder="Buscar municipios" required />
                    </div>
                </div>
                        ...
                        <RecomendacionEvaluador className="mt-8">
                            {#each proyecto.evaluaciones as evaluacion, i}
                                {#if isSuperAdmin || (evaluacion.finalizado && evaluacion.habilitado)}
                                    <div className="bg-zinc-900 p-4 rounded shadow text-white my-2">
                                        <p className="text-xs">Evaluador COD-{evaluacion.id}:</p>
                                        <p className="whitespace-pre-line text-xs">{evaluacion.ta_evaluacion.municipios_comentario ? evaluacion.ta_evaluacion.municipios_comentario : 'Sin recomendación'}</p>
                                    </div>
                                {/if}
                            {/each}
                            {#if proyecto.evaluaciones.length == 0}
                ...
                <div className="py-24 grid grid-cols-2 gap-4">
                    <div>
                        <Label required={$form.otras_nombre_instituciones_programas ? undefined : true} className="mb-4" labelFor="nombre_instituciones_programas" value="Instituciones donde se están ejecutando los programas y que se espera continuar con el proyecto de TecnoAcademias" />
                    </div>
                    <div>
                        ...
                        <Tags id="nombre_instituciones_programas" className="mt-4" whitelist={whitelistInstitucionesEducativasEjecutar} bind:tags={$form.nombre_instituciones_programas} placeholder="Nombre(s) de la(s) IE" error={errors.nombre_instituciones_programas} required={$form.otras_nombre_instituciones_programas ? undefined : true} />
                        <div className="mt-10">
                ...
                {#if $form.proyeccion_nuevas_instituciones?.value == 1}
                    <div className="py-24 grid grid-cols-2 gap-4">
                        <div>
                            <Label required={$form.otras_nuevas_instituciones ? undefined : true} className="mb-4" labelFor="nuevas_instituciones" value="Nuevas instituciones educativas que se vincularán con el proyecto de TecnoAcademia" />
                        </div>
                        <div>
                            ...
                            <Tags id="nuevas_instituciones" className="mt-4" whitelist={whitelistInstitucionesEducativasEjecutar} bind:tags={$form.nuevas_instituciones} placeholder="Nombre(s) de la(s) IE" error={errors.nuevas_instituciones} required={$form.otras_nuevas_instituciones ? undefined : true} />
                            <div className="mt-10">
                                <InfoMessage>Si no encuentra alguna institución educativa en la anterior lista por favor escriba el nombre en el siguiente campo de texto</InfoMessage>
                ...
                {#if $form.proyeccion_articulacion_media?.value == 1}
                    <div className="py-24 grid grid-cols-2 gap-4">
                        <div>
                            <Label required={$form.otras_nombre_instituciones ? undefined : true} className="mb-4" labelFor="nombre_instituciones" value="Instituciones donde se implementará el programa que tienen <strong>articulación con la Media</strong>" />
                        </div>
                        <div>
                            ...
                            <Tags id="nombre_instituciones" className="mt-4" whitelist={whitelistInstitucionesEducativasArticular} bind:tags={$form.nombre_instituciones} placeholder="Nombre(s) de la(s) IE" error={errors.nombre_instituciones} required={$form.otras_nombre_instituciones ? undefined : true} />
                            <div className="mt-10">
                                <InfoMessage>Si no encuentra alguna institución educativa en la anterior lista por favor escriba el nombre en el siguiente campo de texto</InfoMessage>
                    ...
                    <RecomendacionEvaluador className="mt-8">
                        {#each proyecto.evaluaciones as evaluacion, i}
                            {#if isSuperAdmin || (evaluacion.finalizado && evaluacion.habilitado)}
                                <div className="bg-zinc-900 p-4 rounded shadow text-white my-2">
                                    <p className="text-xs">Evaluador COD-{evaluacion.id}:</p>
                                    <p className="whitespace-pre-line text-xs">{evaluacion.ta_evaluacion.instituciones_comentario ? evaluacion.ta_evaluacion.instituciones_comentario : 'Sin recomendación'}</p>
                                </div>
                            {/if}
                        {/each}
                        {#if proyecto.evaluaciones.length == 0}
                ...
                <div className="py-24 grid grid-cols-2 gap-4">
                    <div>
                        <Label required className="mb-4" labelFor="programas_formacion_articulados" value="Programas de articulación con la Media con los cuales se espera dar continuidad a la ruta de formación de los aprendices de la TecnoAcademia" />
                    </div>
                    <div>
                        <MultipleSelect id="programas_formacion_articulados" bind:selectedValue={$form.programas_formacion_articulados} items={programasFormacion}  error={errors.programas_formacion_articulados} placeholder="Buscar por el nombre del programa de formación" required />
                        <InfoMessage>
                ...
                <div className="py-24 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <MultipleSelect id="diseno_curricular_id" bind:selectedValue={$form.diseno_curricular_id} items={disenosCurriculares}  error={errors.diseno_curricular_id} placeholder="Buscar por el nombre del programa de formación" required />
                    </div>
                </div>
                ...
                <div>
                    <div className="py-24 grid grid-cols-2 gap-4">
                        <div>
                            <Label required className="mb-4" labelFor="proyectos_macro" value="Proyectos Macro o líneas de proyecto de investigación formativa y aplicada de la TecnoAcademia para la vigencia {convocatoria.year}" />
                        </div>
                        <div>
                        ...
                        <RecomendacionEvaluador className="mt-8">
                            {#each proyecto.evaluaciones as evaluacion, i}
                                {#if isSuperAdmin || (evaluacion.finalizado && evaluacion.habilitado)}
                                    <div className="bg-zinc-900 p-4 rounded shadow text-white my-2">
                                        <p className="text-xs">Evaluador COD-{evaluacion.id}:</p>
                                        <p className="whitespace-pre-line text-xs">{evaluacion.ta_evaluacion.proyectos_macro_comentario ? evaluacion.ta_evaluacion.proyectos_macro_comentario : 'Sin recomendación'}</p>
                                    </div>
                                {/if}
                            {/each}
                            {#if proyecto.evaluaciones.length == 0}
                ...
                <div>
                    <div className="py-24 grid grid-cols-2 gap-4">
                        <div>
                            <Label required className="mb-4" labelFor="articulacion_plan_educacion" value="Articulación de la TecnoAcademia con el Plan Decenal de Educación y su regionalización en el territorio: mencionar logros de la vigencia {convocatoria.year - 1} y {convocatoria.year}" />
                        </div>
                        <div>
                ...
                <div>
                    <div className="py-24 grid grid-cols-2 gap-4">
                        <div>
                            <Label required className="mb-4" labelFor="articulacion_territorios_stem" value="Artifculación de la TecnoAcademia con la Iniciativa de Territorios STEM+ del Ministerio de Educación en el Territorio" />
                        </div>
                        <div>
            ...
            {:else if proyecto.codigo_linea_programatica == 69}
                <div className="py-24">
                    <div className="grid grid-cols-2">
                        ...
                        <div>
                            <MultipleSelect id="talento_otros_departamentos" bind:selectedValue={$form.talento_otros_departamentos} items={departamentos}  error={errors.talento_otros_departamentos} placeholder="Buscar departamentos" />
                        </div>
                    </div>
                    ...
                    <div className="mt-24 grid grid-cols-2">
                        <div>
                            <Label required className="mb-4" labelFor="impacto_municipios_tp" value="Descripción del beneficio en los municipios" />
                        </div>
                        <div>
                        ...
                        <RecomendacionEvaluador className="mt-8">
                            {#each proyecto.evaluaciones as evaluacion, i}
                                {#if isSuperAdmin || (evaluacion.finalizado && evaluacion.habilitado)}
                                    <div className="bg-zinc-900 p-4 rounded shadow text-white my-2">
                                        <p className="text-xs">Evaluador COD-{evaluacion.id}:</p>
                                        <p className="whitespace-pre-line text-xs">{evaluacion.tp_evaluacion.municipios_comentario ? evaluacion.tp_evaluacion.municipios_comentario : 'Sin recomendación'}</p>
                                    </div>
                                {/if}
                            {/each}
                            {#if proyecto.evaluaciones.length == 0}
                ...
                <div className="py-24">
                    <div className="grid grid-cols-2">
                        <div>
                            <Label required className="mb-4" labelFor="estrategia_articulacion_prox_vigencia" value="Comparta la estrategia de Articulación para el {convocatoria.year} para los proyectos de los Tecnoparques" />
                        </div>
                        <div>
                ...
                <div className="py-24">
                    <div className="grid grid-cols-2">
                        <div>
                            <Label required className="mb-4" labelFor="alianzas_estrategicas" value="Comparta las alianzas estratégicas a gestionar en el {convocatoria.year} para promover el logro de las metas del Tecnoparque" />
                        </div>
                        <div>
                ...
                <div className="py-24">
                    <div className="grid grid-cols-2">
                        <div>
                            <Label required className="mb-4" labelFor="estrategia_divulgacion" value="Comparta la estrategia de divulgación y visibilización de acciones del Tecnoparque para el {convocatoria.year}" />
                        </div>
                        <div>
                ...
                <div className="py-24">
                    <div className="grid grid-cols-2">
                        <div>
                            <Label required className="mb-4" labelFor="promover_productividad" value="Proponga las estrategias para el {convocatoria.year} con el fin de que el Tecnoparque contribuya desde la ciencia, la Tecnología e Innovación a promover la productividad e innovación agropecuaria y agroindustrial" />
                        </div>
                        <div>
        ...
        <div className="shadow-inner bg-app-200 border-app-400 flex items-center justify-between px-8 py-4">
            {#if proyecto.allowed.to_update}
                <PrimaryButton loading={$form.processing} className="ml-auto" type="submit">Guardar información de la metodología</PrimaryButton>
            {/if}
        </div>
    </form>
            ...
            <table className="w-full bg-white whitespace-no-wrap table-fixed data-table mt-10">
                <thead>
                    <tr className="text-left font-bold">
                        <th className="px-6 pt-6 pb-4 sticky top-0 z-10 bg-white shadow-xl w-full text-xs">Placa / Modelo</th>
                        <th className="px-6 pt-6 pb-4 sticky top-0 z-10 bg-white shadow-xl w-full text-xs">Estado</th>
...
<!--
                ...
                {#each proyecto.evaluaciones as evaluacion, i}
                    {#if isSuperAdmin || (evaluacion.finalizado && evaluacion.habilitado)}
                        <div className="bg-zinc-900 p-4 rounded shadow text-white my-2">
                            <p className="text-xs">Evaluador COD-{evaluacion.id}:</p>
                            {#if evaluacion.idi_evaluacion}
                                <p className="whitespace-pre-line text-xs">{evaluacion.idi_evaluacion?.actividades_comentario ? evaluacion.idi_evaluacion.actividades_comentario : 'Sin recomendación'}</p>
                            {:else if evaluacion.cultura_innovacion_evaluacion}
                                <p className="whitespace-pre-line text-xs">{evaluacion.cultura_innovacion_evaluacion?.actividades_comentario ? evaluacion.cultura_innovacion_evaluacion.actividades_comentario : 'Sin recomendación'}</p>
                            {/if}
                        </div>
                    {/if}
                {/each}
    ...
    {#if showGantt}
        <Button on:click={() => (showGantt = false)} className="mt-6">Ocultar diagrama de Gantt</Button>
    {/if}
    ...
    {#if showGantt}
        ...
        />
    {:else}
        <DataTable className="mt-10" routeParams={[convocatoria.id, proyecto.id]}>
            <div slot="actions">
                <Button on:click={() => (showGantt = true)} className="mt-6">Visualizar diagrama de Gantt</Button>
            </div>
            <thead slot="thead">
                <tr className="text-left font-bold">
                    ...
                    <tr className="hover:bg-gray-100 focus-within:bg-gray-100">
                        ...
                        <td className="border-t td-actions">
                            <DataTableMenu className={actividades.data.length < 3 ? 'z-50' : ''}>
                                ...
                                <Separator disabled={!proyecto.allowed.to_update} className={!proyecto.allowed.to_update ? 'hidden' : ''} />
                                <Item on:SMUI:action={() => ((actividadId = actividad.id), (dialogEliminar = true), (allowedToDestroy = proyecto.allowed.to_update))} disabled={!proyecto.allowed.to_update} className={!proyecto.allowed.to_update ? 'hidden' : ''}>
                                    <Text>Eliminar</Text>
                                </Item>
                            </DataTableMenu>
                        </td>
    ...
    {#if proyecto.codigo_linea_programatica == 70}
            ...
            <div slot="content">
                <form on:submit|preventDefault={submitProgramasFormacion} id="programas-formacion-form">
                    <fieldset className="p-8" disabled={proyecto.allowed.to_update ? undefined : true}>
                        <div className="mt-8">
                            <Input label="Nombre" id="nombre" type="text" className="mt-1" bind:value={$formProgramasFormacion.nombre} error={errors.nombre} required />
                        </div>

                        <div className="mt-8">
                            <Input label="Código" id="codigo" type="number" input$min="0" input$max="2147483647" className="mt-1" bind:value={$formProgramasFormacion.codigo} error={errors.codigo} required />
                        </div>
        ...
        <Dialog bind:open={aulaMovilFormDialog} size="950px">
            <div slot="title" className="flex items-center flex-col mt-4">Añadir aula móvil</div>
            <div slot="content">
                <form on:submit|preventDefault={submitAulaMovil} id="aula-movil" bind:this={formContainer}>
                    <fieldset className="p-8" disabled={proyecto.allowed.to_update ? undefined : true}>
                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="placa" value="Placa del vehículo" />
                            <Input id="placa" type="text" className="mt-1" error={errors.placa} bind:value={$formAulaMovil.placa} required />
                        </div>

                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="modelo" value="Modelo del vehículo" />
                            <Input id="modelo" type="number" className="mt-1" error={errors.modelo} input$min="0" bind:value={$formAulaMovil.modelo} required />
                        </div>

                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="logros_vigencia" value="Acciones desarrolladas y logros en la vigencia actual con el Aula Móvil" />
                        ...
                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="numero_municipios_visitados" value="Número de municipios visitados en la vigencia actual" />
                            <Input id="numero_municipios_visitados" type="number" className="mt-1" error={errors.numero_municipios_visitados} input$min="0" bind:value={$formAulaMovil.numero_municipios_visitados} required />
                        </div>

                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="numero_aprendices_beneficiados" value="Número de aprendices beneficiados por el Aula Móvil en la vigencia {convocatoria.year - 1}" />
                            <Input id="numero_aprendices_beneficiados" type="number" className="mt-1" error={errors.numero_aprendices_beneficiados} input$min="0" bind:value={$formAulaMovil.numero_aprendices_beneficiados} required />
                        </div>

                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="estado" value="Estado actual (mecánico) del Aula Móvil " />
                            <Input id="estado" type="text" className="mt-1" error={errors.estado} bind:value={$formAulaMovil.estado} required />
                        </div>

                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="modulos_interactivos" value="Módulos interactivos en el Aula Móvil " />
                        ...
                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="acciones_a_desarrollar" value="Acciones que espera desarrollar con el Aula Móvole en la vigencia {convocatoria.year}" />
                        ...
                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="numero_aprendices_a_beneficiar" value="Número de aprendices a beneficiar en la viencia {convocatoria.year}" />
                            <Input id="numero_aprendices_a_beneficiar" type="number" className="mt-1" error={errors.numero_aprendices_a_beneficiar} input$min="0" bind:value={$formAulaMovil.numero_aprendices_a_beneficiar} required />
                        </div>

                        <div className="mt-8">
                            <Label required className="mb-4" labelFor="recursos_mantenimiento" value="Requerimientos de recursos de Mantenimiento para la vigencia {convocatoria.year}" />
                        ...
                        <div className="mt-8">
                            <Label className="mb-4" labelFor="soat" value="SOAT" />
                        ...
                        <div className="mt-8">
                            <Label className="mb-4" labelFor="soat" value="Técnico mecánica" />
            ...
            <div slot="actions">
                <div className="p-4">
                    ...
                    {#if proyecto.allowed.to_update}
                        <PrimaryButton type="submit" loading={$formAulaMovil.processing} form="aula-movil">Guardar</PrimaryButton>
                    {/if}
                </div>
            </div>
        </Dialog>
        ...
        <Dialog bind:open={destroyAulaMovilDialog}>
            ...
            <div slot="actions">
                <div className="p-4">
                    ...
                    <PrimaryButton loading={$formAulaMovil.processing} variant="raised" on:click={destroyAulaMovil}>Confirmar</PrimaryButton>
                </div>
            </div>
        </Dialog>
    {/if}
