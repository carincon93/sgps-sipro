...
const Actividades = ({
    ...
    const form_metodologia_proyecto_tecnoparque = useForm({
        metodologia: proyecto.proyecto_formulario17_linea69?.metodologia,
        metodologia_local: proyecto.proyecto_formulario17_linea69?.metodologia_local,
        areas_cualificacion_mnc: proyecto.proyecto_formulario17_linea69?.areas_cualificacion_mnc,
        talentos_otros_departamentos: proyecto.proyecto_formulario17_linea69?.talentos_otros_departamentos,
        estrategia_atencion_talentos: proyecto.proyecto_formulario17_linea69?.estrategia_atencion_talentos,
        acciones_mejoramiento_idic: proyecto.proyecto_formulario17_linea69?.acciones_mejoramiento_idic,
        municipios_beneficiados_vigencia_anterior: proyecto.proyecto_formulario17_linea69?.municipios_beneficiados_vigencia_anterior,
        beneficio_municipios_vigencia_anterior: proyecto.proyecto_formulario17_linea69?.beneficio_municipios_vigencia_anterior,
        municipios_beneficiados_vigencia_actual: proyecto.proyecto_formulario17_linea69?.municipios_beneficiados_vigencia_actual,
        estrategia_articulacion_pbts: proyecto.proyecto_formulario17_linea69?.estrategia_articulacion_pbts,
        numero_empresas_atendidas: proyecto.proyecto_formulario17_linea69?.numero_empresas_atendidas,
        analisis_impacto_sector_empresarial: proyecto.proyecto_formulario17_linea69?.analisis_impacto_sector_empresarial,
        numero_emprendedores_atendidos: proyecto.proyecto_formulario17_linea69?.numero_emprendedores_atendidos,
        analisis_impacto_regional: proyecto.proyecto_formulario17_linea69?.analisis_impacto_regional,
        gestion_alianzas_estrategicas: proyecto.proyecto_formulario17_linea69?.gestion_alianzas_estrategicas,
        estrategias_visibilizacion: proyecto.proyecto_formulario17_linea69?.estrategias_visibilizacion,
        integracion_plan_tecnologico: proyecto.proyecto_formulario17_linea69?.integracion_plan_tecnologico,
        estrategias_productividad_agropecuaria: proyecto.proyecto_formulario17_linea69?.estrategias_productividad_agropecuaria,
        acciones_estrategia_campesena: proyecto.proyecto_formulario17_linea69?.acciones_estrategia_campesena,
        estrategia_campesena_campesinos: proyecto.proyecto_formulario17_linea69?.estrategia_campesena_campesinos,
        acciones_fortalecimiento_economia_popular: proyecto.proyecto_formulario17_linea69?.acciones_fortalecimiento_economia_popular,
        acciones_fortalecimiento_idi: proyecto.proyecto_formulario17_linea69?.acciones_fortalecimiento_idi,
    })

    const submitMetodologiaProyectoTecnoparque = (e) => {
        e.preventDefault()
        if (proyecto.allowed.to_update) {
            form_metodologia_proyecto_tecnoparque.put(route('convocatorias.proyectos.metodologia-proyecto-tecnoparque', [convocatoria.id, proyecto.id]), {
                preserveScroll: true,
            })
        }
    }

    const form_metdologia_proyecto_formulario_11_inea_83 = useForm({
    ...
    const submitMetodologiaProyectoFormulario11Linea83 = (e) => {
        e.preventDefault()
        if (proyecto.allowed.to_update) {
            form_metdologia_proyecto_formulario_11_inea_83.put(route('convocatorias.proyectos.metodologia-proyecto-linea-83', [convocatoria.id, proyecto.id]), {
                preserveScroll: true,
            })
        }
    }
                ...
                <div>
                    ...
                    {proyecto.tipo_formulario_convocatoria_id == 10 && (
                        <form onSubmit={submitMetodologiaProyectoHub} className="!mt-20">
                            <Grid container rowSpacing={20}>
                                <Grid item md={12}>
                                    <Label required className="mb-4" labelFor="metodologia" value="Metodología General implemetnada por el Hub de Innovación" />
                    ...
                    {proyecto.tipo_formulario_convocatoria_id == 17 && (
                        <form onSubmit={submitMetodologiaProyectoTecnoparque} className="!mt-20">
                            <Grid container rowSpacing={20}>
                                <Grid item md={12}>
                                    <Label required className="mb-4" labelFor="metodologia" value="Metodología General implemetnada por el Tecnoparque" />

                                    <Textarea
                                        id="metodologia"
                                        error={form_metodologia_proyecto_tecnoparque.errors.metodologia}
                                        value={form_metodologia_proyecto_tecnoparque.data.metodologia}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('metodologia', e.target.value)}
                                        onBlur={() => syncColumnLong('metodologia', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="metodologia_local"
                                        value={`A continuación, describa la metodología que será implementada en el ${convocatoria.year} en el nodo para lograr los objetivos propuestos en cada una de las etapas definidas para los Tecnoparques:`}
                                    />

                                    <Textarea
                                        id="metodologia_local"
                                        error={form_metodologia_proyecto_tecnoparque.errors.metodologia_local}
                                        value={form_metodologia_proyecto_tecnoparque.data.metodologia_local}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('metodologia_local', e.target.value)}
                                        onBlur={() => syncColumnLong('metodologia_local', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={6}>
                                ...
                                <Grid item md={6}>
                                    <SelectMultiple
                                        id="areas_cualificacion_mnc"
                                        bdValues={form_metodologia_proyecto_tecnoparque.data.areas_cualificacion_mnc}
                                        options={areas_cualificacion_mnc}
                                        onChange={(event, newValue) => {
                                            const selected_values = newValue.map((option) => option.value)
                                            form_metodologia_proyecto_tecnoparque.setData((prevData) => ({
                                                ...prevData,
                                                areas_cualificacion_mnc: selected_values,
                                            }))
                                        }}
                                        error={form_metodologia_proyecto_tecnoparque.errors.areas_cualificacion_mnc}
                                        label="Seleccione una o varias opciones"
                                        required
                                        disabled={evaluacion ? true : false}
                                        onBlur={() => syncColumnLong('areas_cualificacion_mnc', form_metodologia_proyecto_tecnoparque)}
                                    />
                                </Grid>
                                <Grid item md={6}>
                                    <Label
                                ...
                                <Grid item md={6}>
                                    <SelectMultiple
                                        id="talentos_otros_departamentos"
                                        bdValues={form_metodologia_proyecto_tecnoparque.data.talentos_otros_departamentos}
                                        options={regionales}
                                        onChange={(event, newValue) => {
                                            const selected_values = newValue.map((option) => option.value)
                                            form_metodologia_proyecto_tecnoparque.setData((prevData) => ({
                                        ...
                                        error={form_metodologia_proyecto_tecnoparque.errors.talentos_otros_departamentos}
                                        label="Seleccione una o varias opciones"
                                        required
                                        disabled={evaluacion ? true : false}
                                        onBlur={() => syncColumnLong('talentos_otros_departamentos', form_metodologia_proyecto_tecnoparque)}
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    <Label
                                    ...
                                    <Textarea
                                        id="estrategia_atencion_talentos"
                                        error={form_metodologia_proyecto_tecnoparque.errors.estrategia_atencion_talentos}
                                        value={form_metodologia_proyecto_tecnoparque.data.estrategia_atencion_talentos}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('estrategia_atencion_talentos', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategia_atencion_talentos', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="acciones_mejoramiento_idic"
                                        value={`Describa las acciones que serán realizadas en el ${convocatoria.year} para cotriuir al mejoramiento del IDIC del Departamento, desde el Tecnoparque`}
                                    />

                                    <Textarea
                                        id="acciones_mejoramiento_idic"
                                        error={form_metodologia_proyecto_tecnoparque.errors.acciones_mejoramiento_idic}
                                        value={form_metodologia_proyecto_tecnoparque.data.acciones_mejoramiento_idic}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('acciones_mejoramiento_idic', e.target.value)}
                                        onBlur={() => syncColumnLong('acciones_mejoramiento_idic', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={6}>
                                ...
                                <Grid item md={6}>
                                    <SelectMultiple
                                        id="municipios_beneficiados_vigencia_anterior"
                                        bdValues={form_metodologia_proyecto_tecnoparque.data.municipios_beneficiados_vigencia_anterior}
                                        options={municipios}
                                        isGroupable={true}
                                        groupBy={(option) => option.group}
                                        onChange={(event, newValue) => {
                                        ...
                                        error={form_metodologia_proyecto_tecnoparque.errors.municipios_beneficiados_vigencia_anterior}
                                        label="Seleccione una o varias opciones"
                                        required
                                        disabled={evaluacion ? true : false}
                                        onBlur={() => syncColumnLong('municipios_beneficiados_vigencia_anterior', form_metodologia_proyecto_tecnoparque)}
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    <Label
                                    ...
                                    <Textarea
                                        id="beneficio_municipios_vigencia_anterior"
                                        error={form_metodologia_proyecto_tecnoparque.errors.beneficio_municipios_vigencia_anterior}
                                        value={form_metodologia_proyecto_tecnoparque.data.beneficio_municipios_vigencia_anterior}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('beneficio_municipios_vigencia_anterior', e.target.value)}
                                        onBlur={() => syncColumnLong('beneficio_municipios_vigencia_anterior', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={6}>
                                    <SelectMultiple
                                        id="municipios_beneficiados_vigencia_actual"
                                        bdValues={form_metodologia_proyecto_tecnoparque.data.municipios_beneficiados_vigencia_actual}
                                        options={municipios}
                                        isGroupable={true}
                                        groupBy={(option) => option.group}
                                        onChange={(event, newValue) => {
                                        ...
                                        error={form_metodologia_proyecto_tecnoparque.errors.municipios_beneficiados_vigencia_actual}
                                        label="Seleccione una o varias opciones"
                                        required
                                        disabled={evaluacion ? true : false}
                                        onBlur={() => syncColumnLong('municipios_beneficiados_vigencia_actual', form_metodologia_proyecto_tecnoparque)}
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    <Label
                                    ...
                                    <Textarea
                                        id="estrategia_articulacion_pbts"
                                        error={form_metodologia_proyecto_tecnoparque.errors.estrategia_articulacion_pbts}
                                        value={form_metodologia_proyecto_tecnoparque.data.estrategia_articulacion_pbts}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('estrategia_articulacion_pbts', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategia_articulacion_pbts', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>

                                <Grid item md={6}>
                                    <Label required className="mb-4" labelFor="numero_empresas_atendidas" value={`Número de Empresas atendidas en el ${convocatoria.year - 1}, por el Tecnoparque?`} />
                                </Grid>
                                <Grid item md={6}>
                                    <TextInput
                                        id="numero_empresas_atendidas"
                                        type="number"
                                        error={form_metodologia_proyecto_tecnoparque.errors.numero_empresas_atendidas}
                                        value={form_metodologia_proyecto_tecnoparque.data.numero_empresas_atendidas}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('numero_empresas_atendidas', e.target.value)}
                                        onBlur={() => syncColumnLong('numero_empresas_atendidas', form_metodologia_proyecto_tecnoparque)}
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    ...
                                    <Textarea
                                        id="analisis_impacto_sector_empresarial"
                                        error={form_metodologia_proyecto_tecnoparque.errors.analisis_impacto_sector_empresarial}
                                        value={form_metodologia_proyecto_tecnoparque.data.analisis_impacto_sector_empresarial}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('analisis_impacto_sector_empresarial', e.target.value)}
                                        onBlur={() => syncColumnLong('analisis_impacto_sector_empresarial', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={6}>
                                    <TextInput
                                        id="numero_emprendedores_atendidos"
                                        type="number"
                                        error={form_metodologia_proyecto_tecnoparque.errors.numero_emprendedores_atendidos}
                                        value={form_metodologia_proyecto_tecnoparque.data.numero_emprendedores_atendidos}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('numero_emprendedores_atendidos', e.target.value)}
                                        onBlur={() => syncColumnLong('numero_emprendedores_atendidos', form_metodologia_proyecto_tecnoparque)}
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    ...
                                    <Textarea
                                        id="analisis_impacto_regional"
                                        error={form_metodologia_proyecto_tecnoparque.errors.analisis_impacto_regional}
                                        value={form_metodologia_proyecto_tecnoparque.data.analisis_impacto_regional}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('analisis_impacto_regional', e.target.value)}
                                        onBlur={() => syncColumnLong('analisis_impacto_regional', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="gestion_alianzas_estrategicas"
                                        value={`Comparta las alianzas estratégicas a gestionar en el ${convocatoria.year} para promover el logro de las metas del Tecnoparque`}
                                    />

                                    <Textarea
                                        id="gestion_alianzas_estrategicas"
                                        error={form_metodologia_proyecto_tecnoparque.errors.gestion_alianzas_estrategicas}
                                        value={form_metodologia_proyecto_tecnoparque.data.gestion_alianzas_estrategicas}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('gestion_alianzas_estrategicas', e.target.value)}
                                        onBlur={() => syncColumnLong('gestion_alianzas_estrategicas', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="estrategias_visibilizacion"
                                        value={`Comparta la estrategia de divulgación y visibilización de acciones del Tecnoparque para el ${convocatoria.year}`}
                                    />

                                    <Textarea
                                        id="estrategias_visibilizacion"
                                        error={form_metodologia_proyecto_tecnoparque.errors.estrategias_visibilizacion}
                                        value={form_metodologia_proyecto_tecnoparque.data.estrategias_visibilizacion}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('estrategias_visibilizacion', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategias_visibilizacion', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>

                                <Grid item md={12}>
                                    <Label required className="mb-4" labelFor="integracion_plan_tecnologico" value="¿Cómo está integrado el Tecnoparque en el Plan Tecnológico del Centro?" />

                                    <Textarea
                                        id="integracion_plan_tecnologico"
                                        error={form_metodologia_proyecto_tecnoparque.errors.integracion_plan_tecnologico}
                                        value={form_metodologia_proyecto_tecnoparque.data.integracion_plan_tecnologico}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('integracion_plan_tecnologico', e.target.value)}
                                        onBlur={() => syncColumnLong('integracion_plan_tecnologico', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        value={`Proponga las estrategias para el ${
                                            convocatoria.year - 1
                                        } con el fin de que el Tecnoparque contribuya desde la ciencia, la Tecnología e Innovación a promover la productividad e innovación agropecuaria y agroindustrial en los territorios que impacta el Tecnoparque`}
                                    />

                                    <Textarea
                                        id="estrategias_productividad_agropecuaria"
                                        error={form_metodologia_proyecto_tecnoparque.errors.estrategias_productividad_agropecuaria}
                                        value={form_metodologia_proyecto_tecnoparque.data.estrategias_productividad_agropecuaria}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('estrategias_productividad_agropecuaria', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategias_productividad_agropecuaria', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="acciones_estrategia_campesena"
                                        value={`A partir de las necesidades y retos territoriales, plantee cuales serán las acciones a realizar en el ${convocatoria.year}, integradas dentro de la Estrategia Campesena, en las que participará el Tecnoparque`}
                                    />

                                    <Textarea
                                        id="acciones_estrategia_campesena"
                                        error={form_metodologia_proyecto_tecnoparque.errors.acciones_estrategia_campesena}
                                        value={form_metodologia_proyecto_tecnoparque.data.acciones_estrategia_campesena}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('acciones_estrategia_campesena', e.target.value)}
                                        onBlur={() => syncColumnLong('acciones_estrategia_campesena', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="estrategia_campesena_campesinos"
                                        value={`Describa las acciones del Tecnoparque a  realizar en el ${convocatoria.year}, que estarán integradas dentro de la Estrategia Campesena, para beneficiar Campesinos y agremiaciones campesinas y especialmente al acompañamiento de Proyectos de I + D + i tendientes a generar y articular mecanismos de atención diferencial, integral e incluyente, para los campesinos, de acuerdo con sus particularidades sociales, culturales, económicas y territoriales, que faciliten el acceso a los programas de formación y demás servicios de la Entidad`}
                                    />

                                    <Textarea
                                        id="estrategia_campesena_campesinos"
                                        error={form_metodologia_proyecto_tecnoparque.errors.estrategia_campesena_campesinos}
                                        value={form_metodologia_proyecto_tecnoparque.data.estrategia_campesena_campesinos}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('estrategia_campesena_campesinos', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategia_campesena_campesinos', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="acciones_fortalecimiento_economia_popular"
                                        value={`Describa las acciones del  Tecnoparque a  realizar en el ${convocatoria.year}, que estarán direccionadas a fortalecer la Economía Popular`}
                                    />

                                    <Textarea
                                        id="acciones_fortalecimiento_economia_popular"
                                        error={form_metodologia_proyecto_tecnoparque.errors.acciones_fortalecimiento_economia_popular}
                                        value={form_metodologia_proyecto_tecnoparque.data.acciones_fortalecimiento_economia_popular}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('acciones_fortalecimiento_economia_popular', e.target.value)}
                                        onBlur={() => syncColumnLong('acciones_fortalecimiento_economia_popular', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={12}>
                                    <Label
                                        ...
                                        className="mb-4"
                                        labelFor="acciones_fortalecimiento_idi"
                                        value={`Describa las acciones del  Tecnoparque a  realizar en el ${convocatoria.year}, que estarán direccionadas a fortalecer Proyectos de I + D + i tendientes generación eléctrica a partir de fuentes no convencionales de energía renovable`}
                                    />

                                    <Textarea
                                        id="acciones_fortalecimiento_idi"
                                        error={form_metodologia_proyecto_tecnoparque.errors.acciones_fortalecimiento_idi}
                                        value={form_metodologia_proyecto_tecnoparque.data.acciones_fortalecimiento_idi}
                                        onChange={(e) => form_metodologia_proyecto_tecnoparque.setData('acciones_fortalecimiento_idi', e.target.value)}
                                        onBlur={() => syncColumnLong('acciones_fortalecimiento_idi', form_metodologia_proyecto_tecnoparque)}
                                        required
                                    />
                                </Grid>
                            </Grid>
                            ...
                            <div className=" flex items-center justify-between py-4">
                                {proyecto.allowed.to_update && (
                                    <PrimaryButton disabled={form_metodologia_proyecto_tecnoparque.processing} className="ml-auto" type="submit">
                                        Guardar información de la metodología
                                    </PrimaryButton>
                                )}
                            </div>
                        ...
                        <form onSubmit={submitMetodologiaProyectoFormulario11Linea83} className="!mt-20">
                            <Grid container rowSpacing={20}>
                                <Grid item md={12}>
                                    ...
                                    <Textarea
                                        id="metodologia"
                                        error={form_metdologia_proyecto_formulario_11_inea_83.errors.metodologia}
                                        value={form_metdologia_proyecto_formulario_11_inea_83.data.metodologia}
                                        onChange={(e) => form_metdologia_proyecto_formulario_11_inea_83.setData('metodologia', e.target.value)}
                                        onBlur={() => syncColumnLong('metodologia', form_metdologia_proyecto_formulario_11_inea_83)}
                                        required
                                    />
                                </Grid>
                                ...
                                <Grid item md={6}>
                                    <SelectMultiple
                                        ...
                                        bdValues={form_metdologia_proyecto_formulario_11_inea_83.data.departamentos_a_impactar}
                                        options={regionales}
                                        onChange={(event, newValue) => {
                                            const selected_values = newValue.map((option) => option.value)
                                            form_metdologia_proyecto_formulario_11_inea_83.setData((prevData) => ({
                                                ...prevData,
                                                departamentos_a_impactar: selected_values,
                                            }))
                                        }}
                                        error={form_metdologia_proyecto_formulario_11_inea_83.errors.departamentos_a_impactar}
                                        label="Seleccione una o varias opciones"
                                        required
                                        disabled={evaluacion ? true : false}
                                        onBlur={() => syncColumnLong('departamentos_a_impactar', form_metdologia_proyecto_formulario_11_inea_83)}
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    <Label
                                    ...
                                    <Textarea
                                        ...
                                        error={form_metdologia_proyecto_formulario_11_inea_83.errors.estrategias_atencion_empresas_municipios}
                                        value={form_metdologia_proyecto_formulario_11_inea_83.data.estrategias_atencion_empresas_municipios}
                                        onChange={(e) => form_metdologia_proyecto_formulario_11_inea_83.setData('estrategias_atencion_empresas_municipios', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategias_atencion_empresas_municipios', form_metdologia_proyecto_formulario_11_inea_83)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    ...
                                    <Textarea
                                        ...
                                        error={form_metdologia_proyecto_formulario_11_inea_83.errors.estrategias_promover_logros}
                                        value={form_metdologia_proyecto_formulario_11_inea_83.data.estrategias_promover_logros}
                                        onChange={(e) => form_metdologia_proyecto_formulario_11_inea_83.setData('estrategias_promover_logros', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategias_promover_logros', form_metdologia_proyecto_formulario_11_inea_83)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    ...
                                    <Textarea
                                        id="estrategias_visibilizacion"
                                        error={form_metdologia_proyecto_formulario_11_inea_83.errors.estrategias_visibilizacion}
                                        value={form_metdologia_proyecto_formulario_11_inea_83.data.estrategias_visibilizacion}
                                        onChange={(e) => form_metdologia_proyecto_formulario_11_inea_83.setData('estrategias_visibilizacion', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategias_visibilizacion', form_metdologia_proyecto_formulario_11_inea_83)}
                                        required
                                    />
                                </Grid>
                                <Grid item md={12}>
                                    ...
                                    <Textarea
                                        ...
                                        error={form_metdologia_proyecto_formulario_11_inea_83.errors.estrategias_productividad_agropecuaria_agroindustrial}
                                        value={form_metdologia_proyecto_formulario_11_inea_83.data.estrategias_productividad_agropecuaria_agroindustrial}
                                        onChange={(e) => form_metdologia_proyecto_formulario_11_inea_83.setData('estrategias_productividad_agropecuaria_agroindustrial', e.target.value)}
                                        onBlur={() => syncColumnLong('estrategias_productividad_agropecuaria_agroindustrial', form_metdologia_proyecto_formulario_11_inea_83)}
                                        required
                                    />
                                </Grid>
                            </Grid>
                            <div className=" flex items-center justify-between py-4">
                                {proyecto.allowed.to_update && (
                                    <PrimaryButton disabled={form_metdologia_proyecto_formulario_11_inea_83.processing} className="ml-auto" type="submit">
                                        Guardar información de la metodología
                                    </PrimaryButton>
                                )}
                            </div>
