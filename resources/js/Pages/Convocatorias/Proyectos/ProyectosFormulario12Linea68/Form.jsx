            ...
            <Grid container rowSpacing={20}>
                ...
                <Grid item md={12}>
                    <Label
                        ...
                        value="Título: Debe corresponder al contenido del proyecto y responder a los siguientes interrogantes: ¿Qué se va a hacer?, ¿Sobre qué o quiénes se hará?, ¿Cómo?, ¿Dónde se llevará a cabo? Tiene que estar escrito de manera breve y concisa. Un buen título describe con exactitud y usando el menor número posible de palabras el tema central del proyecto. Nota: las respuestas a las preguntas anteriormente formuladas no necesariamente deben responderse en mismo orden en el que aparecen. (Máximo 40 palabras)"
                    />
                    <Textarea
                        id="titulo"
                ...
                <Grid item md={6}>
                    <Label required className="mb-4" labelFor="tipo_proyecto_linea_68_id" value="Centro de formación y Línea Técnica" />
                </Grid>
                <Grid item md={6}>
                    {method == 'POST' ? (
                        <Autocomplete
                ...
                <Grid item md={6}>
                    <Label required className="mb-4" labelFor="sector_productivo" value="Estrategia SENA priorizada" />
                </Grid>
                <Grid item md={6}>
                    <Autocomplete
                ...
                {method == 'PUT' && (
                    <>
                        ...
                        <Grid item md={12}>
                            <Label required className="mb-4" labelFor="resumen" value="Resumen ejecutivo" />
                        ...
                        <Grid item md={6}>
                            <Label required className="mb-4" labelFor="programas_formacion_relacionados" value="Nombre de los programas de formación con los que se relaciona el proyecto" />
                        </Grid>
                        <Grid item md={6}>
                            <SelectMultiple
                        ...
                        <Grid item md={6}>
                            <Label required className="mb-4" labelFor="programas_formacion" value="Nombre de los programas de formación con registro calificado con los que se relaciona el proyecto" />
                        </Grid>
                        <Grid item md={6}>
                            <SelectMultiple
                        ...
                        <Grid item md={6}>
                            <Label required className="mb-4" labelFor="municipios_influencia" value="Zonas de influencia" />
                        </Grid>
                        <Grid item md={6}>
                            <SelectMultiple
                        ...
                        <Grid item md={6}>
                            <Label className="mb-4" labelFor="otras_zonas_influencia" value="Otras zonas de influencia (Veredas, corregimientos)" />
                        </Grid>
                        <Grid item md={6}>
                            <TextInput
