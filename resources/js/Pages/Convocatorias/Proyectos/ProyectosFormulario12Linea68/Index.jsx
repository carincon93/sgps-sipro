...
const Index = ({ auth, convocatoria, proyectos_formulario_12_linea_68, allowed_to_create }) => {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Lista de proyectos - Formulario 12 Línea 68" />
                                    ...
                                    <MenuMui text={<MoreVertIcon />}>
                                        {proyecto.id !== proyecto_formulario_12_linea_68_to_destroy ? (
                                            <div>
                                                ...
                                                <MenuItem>
                                                    <a href={route(`convocatorias.proyectos.pdf-formulario12-linea68`, [convocatoria.id, proyecto.id])} target="_blank" className="flex items-center">
                                                        PDF del proyecto
                                                    </a>
                                                </MenuItem>
