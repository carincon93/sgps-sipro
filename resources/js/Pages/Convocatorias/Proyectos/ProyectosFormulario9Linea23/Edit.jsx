                        ...
                        {comentarios_evaluaciones && (
                            <>
                                ...
                                <DialogMui
                                    ...
                                    dialogContent={
                                        <>
                                            {proyecto_formulario_9_linea_23?.proyecto.evaluaciones.map((evaluacion, i) => (
                                                    ...
                                                    comentarios_evaluaciones
                                                        ...
                                                        .map((field, i) => (
                                                            <TableRow key={i}>
                                                                ...
                                                                <TableCell>
                                                                    {proyecto_formulario_9_linea_23?.proyecto.evaluaciones[evaluacion_index]?.evaluacion_proyecto_formulario9_linea23[field] ?? 'Sin comentarios'}
                                                                </TableCell>
                                                            </TableRow>
                                                        ))}
                                            </TableMui>
