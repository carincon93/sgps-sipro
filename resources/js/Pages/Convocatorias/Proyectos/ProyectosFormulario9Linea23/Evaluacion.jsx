...
const Evaluacion = ({ convocatoria, evaluacion, allowed, proyecto, setDialogEvaluacionStatus, ...props }) => {
    const evaluacion_proyecto_formulario9_linea23 = evaluacion.evaluacion_proyecto_formulario9_linea23 ?? evaluacion

    const form = useForm({
        evaluacion_id: evaluacion?.id,
        clausula_confidencialidad: evaluacion?.clausula_confidencialidad ?? evaluacion?.evaluacion?.clausula_confidencialidad,
        titulo_puntaje: evaluacion_proyecto_formulario9_linea23?.titulo_puntaje,
        titulo_comentario: evaluacion_proyecto_formulario9_linea23?.titulo_comentario ? evaluacion_proyecto_formulario9_linea23?.titulo_comentario : '',
        titulo_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.titulo_comentario == null ? true : false,
        entidad_aliada_puntaje: evaluacion_proyecto_formulario9_linea23?.entidad_aliada_puntaje,
        video_puntaje: evaluacion_proyecto_formulario9_linea23?.video_puntaje,
        video_comentario: evaluacion_proyecto_formulario9_linea23?.video_comentario ? evaluacion_proyecto_formulario9_linea23?.video_comentario : '',
        video_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.video_comentario == null ? true : false,

        entidad_aliada_comentario: evaluacion_proyecto_formulario9_linea23?.entidad_aliada_comentario ? evaluacion_proyecto_formulario9_linea23?.entidad_aliada_comentario : '',
        entidad_aliada_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.entidad_aliada_comentario == null ? true : false,

        resumen_puntaje: evaluacion_proyecto_formulario9_linea23?.resumen_puntaje,
        resumen_comentario: evaluacion_proyecto_formulario9_linea23?.resumen_comentario ? evaluacion_proyecto_formulario9_linea23?.resumen_comentario : '',
        resumen_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.resumen_comentario == null ? true : false,
        problema_central_puntaje: evaluacion_proyecto_formulario9_linea23?.problema_central_puntaje,
        problema_central_comentario: evaluacion_proyecto_formulario9_linea23?.problema_central_comentario ? evaluacion_proyecto_formulario9_linea23?.problema_central_comentario : '',
        problema_central_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.problema_central_comentario == null ? true : false,
        resultados_puntaje: evaluacion_proyecto_formulario9_linea23?.resultados_puntaje,
        resultados_comentario: evaluacion_proyecto_formulario9_linea23?.resultados_comentario ? evaluacion_proyecto_formulario9_linea23?.resultados_comentario : '',
        resultados_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.resultados_comentario == null ? true : false,
        objetivos_puntaje: evaluacion_proyecto_formulario9_linea23?.objetivos_puntaje,
        objetivos_comentario: evaluacion_proyecto_formulario9_linea23?.objetivos_comentario ? evaluacion_proyecto_formulario9_linea23?.objetivos_comentario : '',
        objetivos_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.objetivos_comentario == null ? true : false,
        metodologia_puntaje: evaluacion_proyecto_formulario9_linea23?.metodologia_puntaje,
        metodologia_comentario: evaluacion_proyecto_formulario9_linea23?.metodologia_comentario ? evaluacion_proyecto_formulario9_linea23?.metodologia_comentario : '',
        metodologia_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.metodologia_comentario == null ? true : false,
        productos_puntaje: evaluacion_proyecto_formulario9_linea23?.productos_puntaje,
        productos_comentario: evaluacion_proyecto_formulario9_linea23?.productos_comentario ? evaluacion_proyecto_formulario9_linea23?.productos_comentario : '',
        productos_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.productos_comentario == null ? true : false,
        cadena_valor_puntaje: evaluacion_proyecto_formulario9_linea23?.cadena_valor_puntaje,
        cadena_valor_comentario: evaluacion_proyecto_formulario9_linea23?.cadena_valor_comentario ? evaluacion_proyecto_formulario9_linea23?.cadena_valor_comentario : '',
        cadena_valor_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.cadena_valor_comentario == null ? true : false,
        analisis_riesgos_puntaje: evaluacion_proyecto_formulario9_linea23?.analisis_riesgos_puntaje,
        analisis_riesgos_comentario: evaluacion_proyecto_formulario9_linea23?.analisis_riesgos_comentario ? evaluacion_proyecto_formulario9_linea23?.analisis_riesgos_comentario : '',
        analisis_riesgos_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.analisis_riesgos_comentario == null ? true : false,

        ortografia_puntaje: evaluacion_proyecto_formulario9_linea23?.ortografia_puntaje,
        ortografia_comentario: evaluacion_proyecto_formulario9_linea23?.ortografia_comentario ? evaluacion_proyecto_formulario9_linea23?.ortografia_comentario : '',
        ortografia_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.ortografia_comentario == null ? true : false,
        redaccion_puntaje: evaluacion_proyecto_formulario9_linea23?.redaccion_puntaje,
        redaccion_comentario: evaluacion_proyecto_formulario9_linea23?.redaccion_comentario ? evaluacion_proyecto_formulario9_linea23?.redaccion_comentario : '',
        redaccion_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.redaccion_comentario == null ? true : false,
        normas_apa_puntaje: evaluacion_proyecto_formulario9_linea23?.normas_apa_puntaje,
        normas_apa_comentario: evaluacion_proyecto_formulario9_linea23?.normas_apa_comentario ? evaluacion_proyecto_formulario9_linea23?.normas_apa_comentario : '',
        normas_apa_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.normas_apa_comentario == null ? true : false,

        justificacion_economia_naranja_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.justificacion_economia_naranja_comentario == null ? true : false,
        justificacion_economia_naranja_comentario: evaluacion_proyecto_formulario9_linea23?.justificacion_economia_naranja_comentario
            ? evaluacion_proyecto_formulario9_linea23?.justificacion_economia_naranja_comentario
            : '',

        justificacion_industria_4_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.justificacion_industria_4_comentario == null ? true : false,
        justificacion_industria_4_comentario: evaluacion_proyecto_formulario9_linea23?.justificacion_industria_4_comentario
            ? evaluacion_proyecto_formulario9_linea23?.justificacion_industria_4_comentario
            : '',

        bibliografia_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.bibliografia_comentario == null ? true : false,
        bibliografia_comentario: evaluacion_proyecto_formulario9_linea23?.bibliografia_comentario ? evaluacion_proyecto_formulario9_linea23?.bibliografia_comentario : '',

        fechas_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.fechas_comentario == null ? true : false,
        fechas_comentario: evaluacion_proyecto_formulario9_linea23?.fechas_comentario ? evaluacion_proyecto_formulario9_linea23?.fechas_comentario : '',

        justificacion_politica_discapacidad_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.justificacion_politica_discapacidad_comentario == null ? true : false,
        justificacion_politica_discapacidad_comentario: evaluacion_proyecto_formulario9_linea23?.justificacion_politica_discapacidad_comentario
            ? evaluacion_proyecto_formulario9_linea23?.justificacion_politica_discapacidad_comentario
            : '',

        actividad_economica_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.actividad_economica_comentario == null ? true : false,
        actividad_economica_comentario: evaluacion_proyecto_formulario9_linea23?.actividad_economica_comentario ? evaluacion_proyecto_formulario9_linea23?.actividad_economica_comentario : '',

        disciplina_subarea_conocimiento_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.disciplina_subarea_conocimiento_comentario == null ? true : false,
        disciplina_subarea_conocimiento_comentario: evaluacion_proyecto_formulario9_linea23?.disciplina_subarea_conocimiento_comentario
            ? evaluacion_proyecto_formulario9_linea23?.disciplina_subarea_conocimiento_comentario
            : '',

        red_conocimiento_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.red_conocimiento_comentario == null ? true : false,
        red_conocimiento_comentario: evaluacion_proyecto_formulario9_linea23?.red_conocimiento_comentario ? evaluacion_proyecto_formulario9_linea23?.red_conocimiento_comentario : '',

        tematica_estrategica_requiere_comentario: evaluacion_proyecto_formulario9_linea23?.tematica_estrategica_comentario == null ? true : false,
        tematica_estrategica_comentario: evaluacion_proyecto_formulario9_linea23?.tematica_estrategica_comentario ? evaluacion_proyecto_formulario9_linea23?.tematica_estrategica_comentario : '',
    })
    ...
    const submit = (e) => {
        ...
        if (allowed.to_update) {
            form.put(route('convocatorias.evaluaciones-formulario-9-linea-23.update', [convocatoria.id, evaluacion.id]), {
            ...
            <form onSubmit={submit} className="space-y-10" id="form-evaluacion">
                ...
                <div>
                    ...
                    <div className="mt-10">
                        ...
                        <SwitchMui className="!my-6" checked={form.data.objetivos_requiere_comentario} onChange={(e) => form.setData('objetivos_requiere_comentario', e.target.checked)} />
                ...
                <div>
                    ...
                    <SwitchMui className="!my-6" checked={form.data.fechas_requiere_comentario} onChange={(e) => form.setData('fechas_requiere_comentario', e.target.checked)} />
                ...
                <div>
                    ...
                    <SwitchMui className="!my-6" checked={form.data.red_conocimiento_requiere_comentario} onChange={(e) => form.setData('red_conocimiento_requiere_comentario', e.target.checked)} />
