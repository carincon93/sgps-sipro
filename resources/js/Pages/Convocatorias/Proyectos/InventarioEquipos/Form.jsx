...
<form on:submit|preventDefault={submit}>
    <fieldset className="p-8" disabled={proyecto.allowed.to_update ? undefined : true}>
        ...
        <div className="mt-8">
            ...
            <input id="fecha_adquisicion" type="date" className="mt-1 block w-full p-4" error={errors.fecha_adquisicion} bind:value={$form.fecha_adquisicion} required />
        </div>

        <div className="mt-8">
            <Label required className="mb-4" labelFor="estado" value="Estado" />
        ...
        <div className="mt-8">
            <Label required className="mb-4" labelFor="uso_st" value="¿Uso exclusivo de Servicios tecnológicos?" />
        ...
        <div className="mt-8">
            <Label required className="mb-4" labelFor="uso_otra_dependencia" value="¿Otra dependencia que usa el equipo?" />
        ...
        <div className="mt-8">
            <Label required className="mb-4" labelFor="descripcion" value="Descripción del equipo (Detalle con qué metodología del proyecto está relacionado este equipamiento)" />
            <Textarea maxlength="10000" id="descripcion" error={errors.descripcion} bind:value={$form.descripcion} required />
        </div>

        <div className="mt-8">
            <Label required className="mb-4" labelFor="mantenimiento_prox_year" value="¿Para el próximo año el equipo necesita mantenimiento?" />
        ...
        <div className="mt-8">
            <Label required className="mb-4" labelFor="calibracion_prox_year" value="¿Para el próximo año el equipo necesita calibración?" />
