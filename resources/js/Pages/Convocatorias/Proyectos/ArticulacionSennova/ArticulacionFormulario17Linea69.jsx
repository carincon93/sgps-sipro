...
const ArticulacionFormulario17Linea69 = ({ convocatoria, proyecto, semilleros_investigacion, grupos_investigacion }) => {
    const form_articulacion_proyecto_formulario_17_linea_69 = useForm({
    ...
    const submitArticulacionSennovaProyectoTecnoparque = (e) => {
        ...
        if (proyecto.allowed.to_update) {
            form_articulacion_proyecto_formulario_17_linea_69.post(route('convocatorias.proyectos.articulacion-sennova-proyectos-formulario-17-linea-69.store', [convocatoria.id, proyecto.id]), {
                preserveScroll: true,
            })
        }
    }
        ...
        <form onSubmit={submitArticulacionSennovaProyectoTecnoparque}>
            <Grid container rowSpacing={20}>
                ...
                <Grid item md={6}>
                    <SelectMultiple
                        ...
                        bdValues={form_articulacion_proyecto_formulario_17_linea_69.data.semilleros_investigacion}
                        options={semilleros_investigacion}
                        onChange={(event, newValue) => {
                            const selected_values = newValue.map((option) => option.value)
                            form_articulacion_proyecto_formulario_17_linea_69.setData((prevData) => ({
                                ...prevData,
                ...
                <Grid item md={6}>
                    <SelectMultiple
                        ...
                        bdValues={form_articulacion_proyecto_formulario_17_linea_69.data.grupos_investigacion}
            ...
            <div className=" flex items-center justify-between mt-14  py-4">
                {proyecto.allowed.to_update && (
                    <PrimaryButton disabled={form_articulacion_proyecto_formulario_17_linea_69.processing} className="ml-auto" type="submit">
                        Guardar
                    </PrimaryButton>
                )}
            </div>
...
export default ArticulacionFormulario17Linea69
