        ...
        <fieldset disabled={proyecto.allowed.to_update ? undefined : true}>
            {#if proyecto.codigo_linea_programatica == 70}
                ...
                <div class="mt-44 grid grid-cols-2">
                    ...
                    <div>
                        <SelectMulti id="proyecto_idi_tecnoacademia_id" bind:selectedValue={$form.proyecto_idi_tecnoacademia_id} items={proyectosIdiTecnoacademia} isMulti={true} error={errors.proyecto_idi_tecnoacademia_id} placeholder="Seleccione uno o varias iniciativas" required />
                ...
                <div class="mt-44 grid grid-cols-2">
                    <div>
                        <Label required class="mb-4" labelFor="articulacion_programas_centro" value="¿Articulación de la TecnoAcademia en los programas de formación del Centro? " />
                    </div>
                    <div>
                ...
                <div class="mt-44 grid grid-cols-2">
                    <div>
                        <Label required class="mb-4" labelFor="articulacion_bienestar_aprendiz" value="¿Articulación de la TecnoAcademia en las acciones de Bienestar al aprendiz del Centro?  " />
                    </div>
                    <div>
                ...
                <div class="mt-44 grid grid-cols-2">
                    <div>
                        <Label required class="mb-4" labelFor="favorecimiento_ruta_formacion" value="¿Acciones conjuntas definidas con el equipo de Articulación con la Media del Centro para favorecer la ruta de formación desde la TecnoAcademia?" />
                    </div>
                    <div>
            ...
            {:else if proyecto.codigo_linea_programatica == 69}
                ...
                <div class="py-24">
                    <div class="grid grid-cols-1">
                        <div>
                            <Label required class="mb-4" labelFor="aportacion_semilleros_grupos" value="Comente la articulación y aporte del TecnoParque proyectada para el {convocatoria.year} a los semilleros y grupos de investigación." />
                        </div>
                        <div>
                ...
                <div class="py-24">
                    <div class="grid grid-cols-1">
                        <div>
                            <Label required class="mb-4" labelFor="proyeccion_con_st" value="¿Cómo proyecta la articulación en el {convocatoria.year}, el Tecnoparque con la línea de Servicios Tecnológicos?" />
                        </div>
                        <div>
                ...
                <div class="py-24">
                    <div class="grid grid-cols-1">
                        <div>
                            <Label required class="mb-4" labelFor="proyeccion_centros_desarrollo" value="¿Cómo proyecta la articulación en el {convocatoria.year}, el Tecnoparque con los centros de desarrollo empresarial de la Regional?" />
                        </div>
                        <div>
                ...
                <div class="py-24">
                    <div class="grid grid-cols-1">
                        <div>
                            <Label required class="mb-4" labelFor="proyeccion_formacion_regional" value="¿Cómo proyecta en el {convocatoria.year}, el Tecnoparque contribuir a la formación en la Regional o en el SENA?" />
                        </div>
                        <div>
                ...
                <div class="mt-44 grid grid-cols-2">
                    <div>
                        <Label required class="mb-4" labelFor="semilleros_investigacion" value="Semillero(s) de investigación" />
                    </div>
                    <div>
                        <SelectMulti id="semilleros_investigacion" bind:selectedValue={$form.semilleros_investigacion} items={semillerosInvestigacion} isMulti={true} error={errors.semilleros_investigacion} placeholder="Buscar por el nombre del semillero de investigación" required />
                    </div>
                ...
                <div class="mt-44 grid grid-cols-2">
                    <div>
                        <Label required class="mb-4" labelFor="grupos_investigacion" value="Grupos de investigación" />
                    </div>
                    <div>
                        <SelectMulti id="grupos_investigacion" bind:selectedValue={$form.grupos_investigacion} items={gruposInvestigacion} isMulti={true} error={errors.grupos_investigacion} placeholder="Buscar por el nombre del grupo de investigación" required />
                    </div>
