    ...
    return (
        <AuthenticatedLayout>
            ...
            <Grid item md={12} className="!mb-20">
                <StepperMui auth_user={auth_user} convocatoria={convocatoria} proyecto={proyecto_formulario_6_linea_82?.proyecto} evaluacion={evaluacion} />
            </Grid>
            ...
            <DialogMui
                ...
                dialogContent={
                    <div className="text-white">
                        ...
                        <h1 className="text-center text-3xl mt-6 mb-10">PROYECTO {proyecto_formulario_6_linea_82?.proyecto.codigo}</h1>
