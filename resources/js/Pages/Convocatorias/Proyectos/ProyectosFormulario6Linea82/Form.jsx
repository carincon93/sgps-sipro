...
const Form = ({
    ...
    const [tiene_video, setTieneVideo] = useState(proyecto_formulario_6_linea_82?.video !== null)
    const [requiere_justificacion_industria4, setRequiereJustificacionIndustria4] = useState(proyecto_formulario_6_linea_82?.justificacion_industria_4 !== null)
    const [requiere_justificacion_economia_naranja, setRequiereJustificacionEconomiaNaranja] = useState(proyecto_formulario_6_linea_82?.justificacion_economia_naranja !== null)
    const [requiere_justificacion_politica_discapacidad, setRequiereJustificacionPoliticaDiscapacidad] = useState(proyecto_formulario_6_linea_82?.justificacion_politica_discapacidad !== null)
    const [requiere_justificacion_atencion_pluralista, setRequiereJustificacionAntencionPluralista] = useState(proyecto_formulario_6_linea_82?.atencion_pluralista_diferencial !== null)
    const [requiere_justificacion_sector_agricola, setRequiereJustificacionSectorAgricola] = useState(proyecto_formulario_6_linea_82?.impacto_sector_agricola !== null)
    const [array_lineas_investigacion, setArrayLineasInvestigacion] = useState([])

    const form = useForm({
        titulo: proyecto_formulario_6_linea_82?.titulo ?? '',
        fecha_inicio: proyecto_formulario_6_linea_82?.fecha_inicio ?? '',
        fecha_finalizacion: proyecto_formulario_6_linea_82?.fecha_finalizacion ?? '',
        max_meses_ejecucion: proyecto_formulario_6_linea_82?.max_meses_ejecucion ?? '',
        centro_formacion_id: proyecto_formulario_6_linea_82?.proyecto?.centro_formacion_id ?? null,
        linea_investigacion_id: proyecto_formulario_6_linea_82?.linea_investigacion_id ?? null,
        red_conocimiento_id: proyecto_formulario_6_linea_82?.red_conocimiento_id ?? null,
        ...
        mesa_sectorial_id: proyecto_formulario_6_linea_82?.proyecto.mesas_sectoriales?.map((item) => item.id),

        muestreo: proyecto_formulario_6_linea_82?.muestreo ?? '',
        actividades_muestreo: proyecto_formulario_6_linea_82?.actividades_muestreo ?? '',
        objetivo_muestreo: proyecto_formulario_6_linea_82?.objetivo_muestreo ?? '',
        recoleccion_especimenes: proyecto_formulario_6_linea_82?.recoleccion_especimenes ?? '',
        relacionado_plan_tecnologico: proyecto_formulario_6_linea_82?.relacionado_plan_tecnologico ?? '',
        relacionado_agendas_competitividad: proyecto_formulario_6_linea_82?.relacionado_agendas_competitividad ?? '',
        ...
        antecedentes: proyecto_formulario_6_linea_82?.antecedentes ?? '',
        marco_conceptual: proyecto_formulario_6_linea_82?.marco_conceptual ?? '',
        justificacion_industria_4: proyecto_formulario_6_linea_82?.justificacion_industria_4 ?? '',
        justificacion_economia_naranja: proyecto_formulario_6_linea_82?.justificacion_economia_naranja ?? '',
        justificacion_politica_discapacidad: proyecto_formulario_6_linea_82?.justificacion_politica_discapacidad ?? '',
        atencion_pluralista_diferencial: proyecto_formulario_6_linea_82?.atencion_pluralista_diferencial ?? '',
        impacto_sector_agricola: proyecto_formulario_6_linea_82?.impacto_sector_agricola ?? '',
        bibliografia: proyecto_formulario_6_linea_82?.bibliografia ?? '',
        impacto_municipios: proyecto_formulario_6_linea_82?.impacto_municipios ?? '',
        impacto_centro_formacion: proyecto_formulario_6_linea_82?.impacto_centro_formacion ?? '',

        // Campos 2023
        aporta_a_campesena: proyecto_formulario_6_linea_82?.aporta_a_campesena,
        relacionado_estrategia_campesena: proyecto_formulario_6_linea_82?.relacionado_estrategia_campesena,
        justificacion_relacion_campesena: proyecto_formulario_6_linea_82?.justificacion_relacion_campesena,
        lineas_estrategicas_convocatoria: proyecto_formulario_6_linea_82?.lineas_estrategicas_convocatoria,
        justificacion_lineas_estrategicas: proyecto_formulario_6_linea_82?.justificacion_lineas_estrategicas,
        impacto_regional: proyecto_formulario_6_linea_82?.impacto_regional,
        justificacion_impacto_regional: proyecto_formulario_6_linea_82?.justificacion_impacto_regional,
        justificacion_mesas_sectoriales: proyecto_formulario_6_linea_82?.justificacion_mesas_sectoriales,
        areas_cualificacion_mnc: proyecto_formulario_6_linea_82?.areas_cualificacion_mnc,
        lineas_estrategicas_beneficiadas: proyecto_formulario_6_linea_82?.lineas_estrategicas_beneficiadas,
        justificacion_lineas_estrategicas_beneficiadas: proyecto_formulario_6_linea_82?.justificacion_lineas_estrategicas_beneficiadas,
        veredas_corregimientos: proyecto_formulario_6_linea_82?.veredas_corregimientos,
    ...
    const submit = (e) => {
        e.preventDefault()
        method == 'POST'
            ? form.post(route('convocatorias.proyectos-formulario-6-linea-82.store', [convocatoria.id]), {
                  preserveScroll: true,
              })
            : proyecto_formulario_6_linea_82.proyecto.allowed.to_update
            ? form.put(route('convocatorias.proyectos-formulario-6-linea-82.update', [convocatoria.id, proyecto_formulario_6_linea_82.id]), {
                  preserveScroll: true,
              })
            : null
    }
    ...
    const syncColumnLong = async (column, form, data) => {
        if (typeof column !== 'undefined' && typeof form !== 'undefined' && proyecto_formulario_6_linea_82?.proyecto?.allowed?.to_update) {
            try {
                await router.put(
                    route('convocatorias.proyectos-formulario-6-linea-82.updateLongColumn', [convocatoria.id, proyecto_formulario_6_linea_82?.proyecto?.id, column]),
    ...
    return (
        <form onSubmit={submit}>
            <Grid container rowSpacing={20}>
                <Grid item md={12}>
                    <div className="flex justify-around items-center bg-indigo-50 shadow rounded p-10">
                        ...
                        <h1>
                            {method == 'PUT' ? (
                                <>
                                    <strong>{proyecto_formulario_6_linea_82.titulo}</strong>
                                    <br />
                                    {proyecto_formulario_6_linea_82.proyecto.codigo}
                                </>
                            ) : (
                ...
                <Grid item md={6}>
                    {method == 'POST' || is_super_admin ? (
                        <Autocomplete
                            ...
                            disabled={!(proyecto_formulario_6_linea_82?.proyecto?.allowed?.to_update || allowed_to_create)}
                            options={
                                centros_formacion ?? [{ value: proyecto_formulario_6_linea_82.proyecto.centro_formacion.id, label: proyecto_formulario_6_linea_82.proyecto.centro_formacion.nombre }]
                            }
                        ...
                        <>{proyecto_formulario_6_linea_82.proyecto.centro_formacion.nombre}</>
                    )}
                    ...
                    {is_super_admin && (
                        <AlertMui className="mt-10" severity="error">
                            ...
                            <strong className=" mt-4 uppercase block">
                                /Convocatoria {convocatoria.year}/{proyecto_formulario_6_linea_82.proyecto.centro_formacion.nombre_carpeta_sharepoint}
                            </strong>
                        </AlertMui>
                    )}
                </Grid>
                ...
                {method == 'PUT' && (
                    <>
                        ...
                        <Grid item md={6}>
                            <SwitchMui className="!mb-4" checked={tiene_video} onChange={() => setTieneVideo(!tiene_video)} disabled={!proyecto_formulario_6_linea_82?.proyecto?.allowed?.to_update} />
                            {tiene_video && (
                                <>
                                    <TextInput
            ...
            {method == 'POST' || proyecto_formulario_6_linea_82.proyecto?.allowed?.to_update ? (
