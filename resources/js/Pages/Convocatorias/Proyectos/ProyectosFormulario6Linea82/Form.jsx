            ...
            <Grid container rowSpacing={20}>
                ...
                {method == 'PUT' && (
                    <>
                        ...
                        {form.data.relacionado_mesas_sectoriales == 1 && (is_super_admin || proyecto_formulario_6_linea_82?.proyecto.allowed.to_update) && (
                            <>
                                <Grid item md={6}>
                        ...
                        {form.data.relacionado_tecnoacademia == 1 && (is_super_admin || proyecto_formulario_6_linea_82?.proyecto.allowed.to_update) && (
                            <>
                                <Grid item md={6}>
