...
<form on:submit|preventDefault={submit} className="bg-white rounded shadow">
    <fieldset className="p-8" disabled={proyecto?.allowed?.to_update ? undefined : true}>
        <div className="mt-8">
            <Label required className="mb-4" labelFor="convocatoria_rol_sennova_id" value="Rol SENNOVA" />
        ...
        {#if proyecto.codigo_linea_programatica != 68}
            <div className="mt-8">
                <Label required className="mb-4" labelFor="descripcion" value="Descripción del perfil requerido" />
        ...
        {#if proyecto.codigo_linea_programatica == 68}
            <div className="mt-8">
                <Label required className="mb-4" labelFor="educacion" value="Educación" />
                <Textarea maxlength="40000" id="educacion" error={errors.educacion} bind:value={$form.educacion} required />
            </div>

            <div className="mt-8">
                <Label required className="mb-4" labelFor="formacion" value="Formación" />
                <Textarea maxlength="40000" id="formacion" error={errors.formacion} bind:value={$form.formacion} required />
            </div>

            <div className="mt-8">
                <Label required className="mb-4" labelFor="experiencia" value="Experiencia" />
        ...
        {#if proyecto.codigo_linea_programatica != 68 && esMonitor == false}
            <div className="mt-8">
                <Input label="Número de meses que requiere el apoyo" id="numero_meses" type="number" input$min="1" input$step="0.1" input$max={diff_meses < 6 ? 6 : diff_meses} className="mt-1" error={errors.numero_meses} bind:value={$form.numero_meses} required />
        ...
        {#if esMonitor == false}
            <div className="mt-8">
                <Input label="Número de personas requeridas" id="numero_roles" type="number" input$min="1" input$max={esMonitor ? 4 : undefined} className="mt-1" error={errors.numero_roles} bind:value={$form.numero_roles} required />
            </div>
        {:else if esMonitor == true}
            <div className="mt-8">
                <Label required className="mb-4" labelFor="numero_monitorias" value="Número de monitorías" />
        ...
        {#if esFacilitador || proyecto.codigo_linea_programatica == 69}
            ...
            <InfoMessage className="ml-10 mb-6">Seleccione una o varias líneas</InfoMessage>
                    ...
                    <div className="flex flex-col">
                        {#each lineasTecnologicas as lineaTecnologica}
                            <FormField className="border-b border-l">
                                ...
                                <span slot="label">
                                    <div className="mb-8">
                                        <small className="block mt-4">Nombre</small>
        ...
        <InfoMessage className="ml-10 mb-6">Seleccione las actividades que debe ejecutar el rol</InfoMessage>
        <div className="bg-white rounded shadow overflow-hidden">
            <div className="p-4">
                ...
                <div className="flex flex-col">
                    {#each actividades as actividad}
                        <FormField className="border-b border-l">
                            ...
                            <span slot="label">
                                <div className="mb-8">
                                    <small className="block mt-4">Descripción</small>
                                    {actividad.descripcion}
                                    <br />
                                    <small className="block mt-4">Objetivo específico # {actividad.objetivo_especifico.numero}</small>
                ...
                <div className="p-2">
                    <ul className="list-disc p-4">
                        {#each actividades as actividad}
                            <li className="mb-4">
                                <div className="mb-8">
                                    <small className="block">Actividad</small>
                                    {actividad.descripcion}
                                </div>
                            </li>
                        {/each}
