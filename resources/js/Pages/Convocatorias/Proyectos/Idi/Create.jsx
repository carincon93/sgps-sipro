...
const CreateProyectoIdi = ({
  ...
  useEffect(() => {
    setArraySubareasConocimiento(
      subareasConocimiento.filter((obj) => obj.area_conocimiento_id === data.area_conocimiento_id?.value)
    );
  }, [data.area_conocimiento_id]);

  useEffect(() => {
    setArrayDisciplinasSubareaConocimiento(
      disciplinasSubareaConocimiento.filter((obj) => obj.subarea_conocimiento_id === data.subarea_conocimiento_id?.value)
    );
  }, [data.subarea_conocimiento_id]);

  useEffect(() => {
    setArrayLineasInvestigacion(
      lineasInvestigacion.filter((obj) => obj.centro_formacion_id === data.linea_investigacion_id?.value)
    );
  ...
  const submit = () => {
    if (allowedToCreate) {
      data.post(route('convocatorias.idi.store', [convocatoria.id]));
    }
  };
  ...
  if (data.articulacion_eni?.value === 1) {
    roles = [
      { value: 1, label: 'Dinamizador SENNOVA', maxHoras: 48 },
      { value: 2, label: 'Investigador experto', maxHoras: 48 },
      { value: 3, label: 'Instructor investigador', maxHoras: 16 },
  ...
  } else if (data.proyecto_investigacion_pedagogica?.value === 2 || data.articulacion_eni?.value === 2) {
    roles = [
      { value: 1, label: 'Dinamizador SENNOVA', maxHoras: 48 },
      { value: 2, label: 'Investigador experto', maxHoras: 48 },
      { value: 3, label: 'Instructor investigador', maxHoras: 16 },
  ...
  return (
    <AuthenticatedLayout
      user={authUser}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Crear proyecto de I+D+i</h2>}
    >
    ...
    <form onSubmit={submit}>
        ...
        <div className="py-24">
            ...
            <div className={`mt-4 flex`}>
                <Label labelFor="fecha_inicio" error={errors.fecha_inicio} value="Del" />
                <div className="ml-4">
        ...
        <div className="py-24">
            ...
            <div>
                <Label labelFor="centro_formacion_id" className="mb-4" value="Centro de formación" />
            ...
            <div>
                ...
                onChange={(event, newValue) => setData('centro_formacion_id', newValue)}
        ...
        {data.centro_formacion_id && (
            ...
            <div className="grid grid-cols-2">
                <div>
                <Label labelFor="linea_investigacion_id" className="mb-4" value="Línea de investigación" />
                </div>
                <div>
                <Autocomplete
                    id="linea_investigacion_id"
                    value={data.linea_investigacion_id}
                    onChange={(event, newValue) => setData('linea_investigacion_id', newValue)}
        ...
        <div className="py-24">
            <div className="grid grid-cols-2">
            <div>
                <Label labelFor="linea_programatica_id" className="mb-4" value="Código dependencia presupuestal (SIIF)" />
            </div>
            <div>
                <Autocomplete
                id="linea_programatica_id"
                value={data.linea_programatica_id}
                onChange={(event, newValue)=> setData('linea_programatica_id', newValue)}
        ...
        <div className="grid grid-cols-2">
          <div>
            <Label labelFor="red_conocimiento_id" className="mb-4" value="Red de conocimiento sectorial" />
          </div>
          <div>
            <Autocomplete
              id="red_conocimiento_id"
              value={data.red_conocimiento_id}
              onChange={(event, newValue)=> setData('red_conocimiento_id', newValue)}
      ...
      <div className="py-24">
        <div className="grid grid-cols-2">
          <div>
            <Label labelFor="area_conocimiento_id" className="mb-4" value="Área de conocimiento" />
          </div>
          <div>
            <Autocomplete
              id="area_conocimiento_id"
              value={data.area_conocimiento_id}
              onChange={(event, newValue) => setData('area_conocimiento_id', newValue)}
      ...
      {data.area_conocimiento_id && (
        <div className="py-24">
          <div className="grid grid-cols-2">
            <div>
              <Label labelFor="subarea_conocimiento_id" className="mb-4" value="Subárea de conocimiento" />
            </div>
            <div>
              <Autocomplete
                id="subarea_conocimiento_id"
                value={data.subarea_conocimiento_id}
                onChange={(event, newValue) => setData('subarea_conocimiento_id', newValue)}
                options={arraySubareasConocimiento}
                error={errors.subarea_conocimiento_id}
                autoComplete={false}
                required
              />
            </div>
      ...
      {data.subarea_conocimiento_id && (
        <div className="py-24">
          <div className="grid grid-cols-2">
            <div>
              <Label labelFor="disciplina_subarea_conocimiento_id" className="mb-4" value="Disciplina de la subárea de conocimiento"/>
            </div>
            <div>
              <Autocomplete
                id="disciplina_subarea_conocimiento_id"
                value={data.disciplina_subarea_conocimiento_id}
                onChange={(event, newValue) => setData('disciplina_subarea_conocimiento_id', newValue)}
                options={arrayDisciplinasSubareaConocimiento}
      ...
      <div className="py-24">
        <div className="grid grid-cols-2">
          <div>
            <Label labelFor="actividad_economica_id" className="mb-4" value="¿En cuál de estas actividades económicas se puede aplicar el proyecto?"/>
          </div>
          <div>
            <Autocomplete
              id="actividad_economica_id"
              value={data.actividad_economica_id}
              onChange={(event, newValue) => setData('actividad_economica_id', newValue)}
      ...
      <div className="py-24">
        <div className="grid grid-cols-2">
          <div>
            <Label labelFor="tematica_estrategica_id" className="mb-4" value="Temática estratégica SENA" />
          </div>
          <div>
            <Autocomplete
              id="tematica_estrategica_id"
              value={data.tematica_estrategica_id}
              onChange={(event, newValue) => setData('tematica_estrategica_id', newValue)}
              options={tematicasEstrategicas}
              error={errors.tematica_estrategica_id}
              autoComplete={false}
              required
            />
          </div>
      ...
      {(data.linea_programatica_id?.value === 1 || data.linea_programatica_id?.value === 3) && (
        <div className="py-24">
          <div className="grid grid-cols-2">
            <div>
              <Label labelFor="proyecto_investigacion_pedagogica" className="mb-4" value="¿El proyecto es de investigación pedagógica?" />
            </div>
            <div>
              <Switch
                id="proyecto_investigacion_pedagogica"
                checked={data.proyecto_investigacion_pedagogica}
                onChange={(e) => setData('proyecto_investigacion_pedagogica', e.target.checked)}
              />
            </div>
          </div>
          ...
          {data.proyecto_investigacion_pedagogica && convocatoria.campos_convocatoria.find((element) => element.campo === 'justificacion_proyecto_investigacion_pedagogica').convocatoriaId === convocatoria.id && (
            <div className="mt-44 ml-8 grid grid-cols-2">
              <div>
                <Label labelFor="justificacion_proyecto_investigacion_pedagogica" className="mb-4" value="Justificación" />
              </div>
              <div>
                <Textarea
                  maxLength="40000"
                  id="justificacion_proyecto_investigacion_pedagogica"
                  value={data.justificacion_proyecto_investigacion_pedagogica}
                  onChange={(e) => setData('justificacion_proyecto_investigacion_pedagogica', e.target.value)}
                  required={data.proyecto_investigacion_pedagogica ? 'required' : undefined}
                />
              </div>
            </div>
          )}
          ...
          <div className="ml-8 grid grid-cols-2 mt-24">
            <div>
              <Label labelFor="articulacion_eni" className="mb-4" value="¿El proyecto está articulado con la ENI?" />
            </div>
            <div>
              <Switch
                id="articulacion_eni"
                checked={data.articulacion_eni}
                onChange={(e) => setData('articulacion_eni', e.target.checked)}
              />
            </div>
          </div>
          ...
          <div className="ml-8 grid grid-cols-2 mt-24">
            <div>
              <Label labelFor="grupo_investigacion_eni_id" className="mb-4" value="Grupo de investigación ENI" />
            </div>
            <div>
              <Autocomplete
                id="grupo_investigacion_eni_id"
                value={data.grupo_investigacion_eni_id}
                onChange={(event, newValue) => setData('grupo_investigacion_eni_id', newValue)}
          ...
          <div className="ml-8 grid grid-cols-2 mt-24">
            <div>
              <Label labelFor="linea_investigacion_eni_id" className="mb-4" value="Líneas de investigación ENI" />
            </div>
            <div>
              <Autocomplete
                id="linea_investigacion_eni_id"
                selectedValue={data.linea_investigacion_eni_id || []}
                onChange={(event, newValue) => setData('linea_investigacion_eni_id', newValue)}
          ...
          <div className="ml-8 grid grid-cols-2 mt-24">
            <div>
              <Label labelFor="area_tematica_eni_id" className="mb-4" value="Áreas temáticas ENI" />
            </div>
            <div>
              <Autocomplete
                id="area_tematica_eni_id"
                selectedValue={data.area_tematica_eni_id || []}
                onChange={(event, newValue) => setData('linea_investigacion_eni_id', newValue)}
      ...
      <div className="py-24">
        <div className="grid grid-cols-2">
          <div>
            <Label labelFor="rol_sennova" className="mb-4" value="Rol SENNOVA" />
          </div>
          <div>
            <Autocomplete
              id="rol_sennova"
              value={data.rol_sennova}
              onChange={(event, newValue) => setData('rol_sennova', newValue)}
              options={roles}
              autoComplete={false}
      ...
      {data.fecha_inicio && data.fecha_finalizacion && (
        <div className="py-24">
          <div className="grid grid-cols-2">
            <div>
              <Label labelFor="cantidad_meses" className="mb-4" value="Número de meses de vinculación al proyecto" />
            </div>
            <div>
              <TextInput
                type="number"
                ...
                step="0.1"
                min="1"
                max={monthDiff(data.fecha_inicio, data.fecha_finalizacion)}
                className="mt-1"
                value={data.cantidad_meses}
                onChange={(e) => setData('cantidad_meses', e.target.value)}
      ...
      <div className="py-24">
        <div className="grid grid-cols-2">
          <div>
            <Label labelFor="cantidad_horas" className="mb-4" value="Número de horas semanales dedicadas para el desarrollo del proyecto" />
          </div>
          <div>
            <TextInput
              type="number"
...
export default CreateProyectoIdi;
