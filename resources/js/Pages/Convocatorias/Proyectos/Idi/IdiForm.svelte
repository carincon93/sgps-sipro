...
<div class="py-24">
    <div class="grid grid-cols-2">
        <div>
            <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="red_conocimiento_id" value="Red de conocimiento sectorial" />
        </div>
        <div>
...
<div class="py-24">
    ...
    {#if $form.area_conocimiento_id}
        <div class="mt-44 grid grid-cols-2">
            <div>
                <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="subarea_conocimiento_id" value="Subárea de conocimiento" />
            </div>
            <div>
    ...
    {#if $form.subarea_conocimiento_id}
        <div class="mt-44 grid grid-cols-2">
            <div>
                <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="disciplina_subarea_conocimiento_id" value="Disciplina de la subárea de conocimiento" />
            </div>
            <div>
...
<div class="py-24">
    <div class="grid grid-cols-2">
        <div>
            <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="actividad_economica_id" value="¿En cuál de estas actividades económicas se puede aplicar el proyecto?" />
        </div>
        <div>
...
{#if $form.linea_programatica_id?.value == 1 || $form.linea_programatica_id?.value == 3}
    <div class="py-24">
        <div class="grid grid-cols-2">
            <div>
                <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="proyecto_investigacion_pedagogica" value="¿El proyecto es de investigación pedagógica?" />
            </div>
            <div>
        ...
        {#if $form.proyecto_investigacion_pedagogica}
            {#if convocatoria.campos_convocatoria.find((element) => element.campo == 'justificacion_proyecto_investigacion_pedagogica').convocatoriaId == convocatoria.id}
                <div class="mt-44 ml-8 grid grid-cols-2">
                    <div>
                        <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="justificacion_proyecto_investigacion_pedagogica" value="Justificación" />
                    </div>
                    <div>
            ...
            <div class="ml-8 grid grid-cols-2 mt-24">
                <div>
                    <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="articulacion_eni" value="¿El proyecto está articulado con la ENI?" />
                </div>
                <div>
            ...
            {#if $form.articulacion_eni}
                <div class="ml-8 grid grid-cols-2 mt-24">
                    <div>
                        <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="grupo_investigacion_eni_id" value="Grupo de investigación ENI" />
                    </div>
                    <div>
                ...
                <div class="ml-8 grid grid-cols-2 mt-24">
                    <div>
                        <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="linea_investigacion_eni_id" value="Líneas de investigación ENI" />
                    </div>
                    <div>
                        <SelectMulti id="linea_investigacion_eni_id" bind:selectedValue={$form.linea_investigacion_eni_id} items={lineasInvestigacionEni} isMulti={true} error={errors.linea_investigacion_eni_id} placeholder="Seleccione una o varias opciones" required disabled={evaluacion ? 'disabled' : undefined} />
                    </div>
                </div>

                <div class="ml-8 grid grid-cols-2 mt-24">
                    <div>
                        <Label required disabled={evaluacion ? 'disabled' : undefined} class="mb-4" labelFor="area_tematica_eni_id" value="Áreas temáticas" />
                    </div>
                    <div>
                        <SelectMulti id="area_tematica_eni_id" bind:selectedValue={$form.area_tematica_eni_id} items={areasTematicasEni} isMulti={true} error={errors.area_tematica_eni_id} placeholder="Seleccione una o varias opciones" required disabled={evaluacion ? 'disabled' : undefined} />
                    </div>
                </div>
            {/if}
        {/if}
