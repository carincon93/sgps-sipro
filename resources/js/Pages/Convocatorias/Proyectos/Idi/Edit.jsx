...
const Edit = ({
    ...
    return (
        <AuthenticatedLayout user={authUser} header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">{idi.titulo}</h2>}>
            <header className="pt-[8rem]" slot="header">
                {/* <Stepper convocatoria={convocatoria} proyecto={idi} /> */}
            </header>

            <form onSubmit={submit} id="idi-form">
                <fieldset className="space-y-20" disabled={idi.proyecto.allowed.to_update ? undefined : true}>
                    <Form
                        data={data}
                        setData={setData}
                        errors={errors}
