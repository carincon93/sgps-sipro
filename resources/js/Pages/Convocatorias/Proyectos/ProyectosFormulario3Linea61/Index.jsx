                            ...
                            <TableRow key={id}>
                                ...
                                <TableCell>
                                    ...
                                    (convocatoria.fase == 5 && proyecto?.mostrar_recomendaciones && convocatoria.tipo_convocatoria == 3) ? (
                                        <>
                                            <AlertMui>
                                                {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.estado}
                                                <div>Puntaje: {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.puntaje}</div>
                                                <small>
                                                    Número de recomendaciones: {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.numero_recomendaciones}
                                                    <br />
                                                    Evaluaciones: {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.evaluaciones_habilitadas} habilitada(s) /{' '}
                                                    {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.evaluaciones_finalizadas} finalizada(s)
                                                </small>
                                            </AlertMui>
                                    ...
                                    {is_super_admin || checkRole(auth_user, [18]) ? (
                                        <>
                                            {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.alerta && (
                                                <AlertMui severity="error" className="mt-4">
                                                    Importante: {proyecto?.estado_evaluacion_proyecto_formulario_3_linea_61?.alerta}
                                                </AlertMui>
                                            )}
                                        </>
                                    ) : null}
