...
const Create = ({ auth, convocatoria, centros_formacion, roles_sennova }) => {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Formular proyecto</h2>}>
            <Form is_super_admin={is_super_admin} auth_user={auth_user} method="POST" convocatoria={convocatoria} centros_formacion={centros_formacion} roles_sennova={roles_sennova} />
        </AuthenticatedLayout>
    )
}
