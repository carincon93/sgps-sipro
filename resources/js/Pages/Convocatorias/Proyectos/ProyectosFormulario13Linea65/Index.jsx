...
const Index = ({ auth, convocatoria, proyectos_formulario_13_linea_65, allowed_to_create }) => {
    ...
    const [proyecto_linea_65_to_destroy, setProyectoFormulario13Linea65ToDestroy] = useState(null)

    return (
        <AuthenticatedLayout>
            <Head title="Lista de proyectos - Formulario 13 Línea 65" />
                                    ...
                                    <MenuMui text={<MoreVertIcon />} className="">
                                        {proyecto.id !== proyecto_linea_65_to_destroy ? (
                                            <div>
                                                ...
                                                <MenuItem>
                                                    <a href={route(`convocatorias.proyectos.pdf-formulario13-linea65`, [convocatoria.id, proyecto.id])} target="_blank" className="flex items-center">
                                                        PDF del proyecto
                                                    </a>
                                                </MenuItem>
                                                ...
                                                <MenuItem
                                                    onClick={() => {
                                                        setProyectoFormulario13Linea65ToDestroy(proyecto.id)
                                                    }}
                                            ...
                                            <div>
                                                <MenuItem
                                                    onClick={(e) => {
                                                        setProyectoFormulario13Linea65ToDestroy(null)
                                                    }}>
                                                    Cancelar
                                                </MenuItem>
                                                <MenuItem
