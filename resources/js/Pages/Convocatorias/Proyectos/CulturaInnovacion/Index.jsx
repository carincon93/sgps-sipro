...
<AuthenticatedLayout>
                ...
                <tr className="hover:bg-gray-100 focus-within:bg-gray-100">
                    ...
                    <td className="border-t td-actions">
                        <DataTableMenu className={culturaInnovacion.data.length < 3 ? 'z-50' : ''}>
                            <Item on:SMUI:action={() => Inertia.visit(route('convocatorias.cultura-innovacion.edit', [convocatoria.id, id]))} disabled={!proyecto.allowed.to_view} className={!proyecto.allowed.to_view ? 'hidden' : ''}>
    ...
    <Dialog bind:open={dialogEliminar}>
        ...
        <div slot="content">
            <form on:submit|preventDefault={destroy} id="delete-cultura-innovacion" className="mt-24 mb-28">
