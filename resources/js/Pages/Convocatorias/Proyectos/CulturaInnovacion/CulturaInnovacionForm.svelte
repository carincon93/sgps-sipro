<script>
    ...
    export let selectLineasTecnoacademia
    ...
    export let arrayLineasTecnoacademia
...
<div class="py-24">
    ...
    <div class="mt-4 flex items-start justify-around">
        <div class="mt-4 flex {errors.fecha_inicio ? '' : 'items-center'}">
            ...
            <div class="ml-4">
                <input id="fecha_inicio" type="date" class="mt-1 block w-full p-4" min={convocatoria.min_fecha_inicio_proyectos_cultura} max={convocatoria.max_fecha_finalizacion_proyectos_cultura} bind:value={$form.fecha_inicio} required disabled={evaluacion ? 'disabled' : undefined} />
            </div>
        </div>
        <div class="mt-4 flex {errors.fecha_finalizacion ? '' : 'items-center'}">
            ...
            <div class="ml-4">
                <input id="fecha_finalizacion" type="date" class="mt-1 block w-full p-4" min={convocatoria.min_fecha_inicio_proyectos_cultura} max={convocatoria.max_fecha_finalizacion_proyectos_cultura} bind:value={$form.fecha_finalizacion} required disabled={evaluacion ? 'disabled' : undefined} />
            </div>
        </div>
    </div>
