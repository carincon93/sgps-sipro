                    ...
                    <form onSubmit={submit} className="mt-4 p-4">
                        <fieldset disabled={proyecto.allowed.to_update ? undefined : true}>
                            ...
                            <div className="mt-8">
                                ...
                                <AlertMui hiddenIcon={true}>El vídeo debe incluir durante el recorrido en las instalaciones, una voz en off que justifique puntualmente el proyecto e incluya: el impacto a la formación, al sector productivo y a la política nacional de ciencia, tecnología e innovación.</AlertMui>
                            </div>
