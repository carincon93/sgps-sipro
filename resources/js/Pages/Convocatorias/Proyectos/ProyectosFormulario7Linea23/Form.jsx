...
const Form = ({
    ...
    const form = useForm({
        ...
        grupo_investigacion_eni_id: proyecto_formulario_7_linea_23?.grupo_investigacion_eni_id,
        ...
        area_tematica_eni_id: proyecto_formulario_7_linea_23?.areas_tematicas_eni ? proyecto_formulario_7_linea_23?.areas_tematicas_eni?.map((item) => item.id) : null,
        linea_investigacion_eni_id: proyecto_formulario_7_linea_23?.lineas_investigacion_eni?.map((item) => item.id) ?? null,
        ...
        mesa_sectorial_id: proyecto_formulario_7_linea_23?.mesas_sectoriales?.map((item) => item.id),

        muestreo: proyecto_formulario_7_linea_23?.muestreo ?? '',
        actividades_muestreo: proyecto_formulario_7_linea_23?.actividades_muestreo ?? '',
        objetivo_muestreo: proyecto_formulario_7_linea_23?.objetivo_muestreo ?? '',
        recoleccion_especimenes: proyecto_formulario_7_linea_23?.recoleccion_especimenes ?? '',
        ...
        proyecto_investigacion_pedagogica: proyecto_formulario_7_linea_23?.proyecto_investigacion_pedagogica,
        articulacion_eni: proyecto_formulario_7_linea_23?.articulacion_eni,
        justificacion_proyecto_investigacion_pedagogica: proyecto_formulario_7_linea_23?.justificacion_proyecto_investigacion_pedagogica ?? '',
            ...
            <Grid container rowSpacing={20}>
                ...
                {method == 'PUT' && (
                    <>
                        ...
                        {form.data.relacionado_mesas_sectoriales == 1 && (is_super_admin || proyecto_formulario_7_linea_23?.proyecto.allowed.to_update) && (
                            <>
                                <Grid item md={6}>
                        ...
                        {form.data.relacionado_tecnoacademia == 1 && (is_super_admin || proyecto_formulario_7_linea_23?.proyecto.allowed.to_update) && (
                            <>
                                <Grid item md={6}>
