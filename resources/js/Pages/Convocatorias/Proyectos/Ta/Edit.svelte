<script>
    ...
    let form = useForm({
        ...
        logros_vigencia_anterior: ta.logros_vigencia_anterior ? ta.logros_vigencia_anterior : '',
        resumen: ta.resumen ? ta.resumen : '',
        resumen_regional: ta.resumen_regional ? ta.resumen_regional : '',
        antecedentes: ta.antecedentes ? ta.antecedentes : '',
        antecedentes_tecnoacademia: ta.antecedentes_tecnoacademia ? ta.antecedentes_tecnoacademia : '',
        justificacion_problema: ta.justificacion_problema ? ta.justificacion_problema : '',
        marco_conceptual: ta.marco_conceptual ? ta.marco_conceptual : '',
        bibliografia: ta.bibliografia ? ta.bibliografia : '',
        pertinencia_territorio: ta.pertinencia_territorio ? ta.pertinencia_territorio : '',
        retos_oportunidades: ta.retos_oportunidades ? ta.retos_oportunidades : '',
        lineas_tecnologicas_centro: ta.lineas_tecnologicas_centro ? ta.lineas_tecnologicas_centro : '',
