...
const Index = ({ auth, convocatoria, proyectos_formulario_10_linea_69, allowed_to_create }) => {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Lista de proyectos - Formulario 10 Línea 69" />
            ...
            <Grid container>
                ...
                <Grid item md={12}>
                    ...
                    <TableMui rows={['Hub Innovación', 'Fecha de ejecución', 'Estado (Evaluación)', 'Acciones']} sxCellThead={{ width: '320px' }}>
                        ...
                        {proyectos_formulario_10_linea_69.data.map(({ id, proyecto, titulo, fecha_ejecucion, proyecto_base }) => (
                            <TableRow key={id}>
                                <TableCell>
                                    <div>
                                    ...
                                    <MenuMui text={<MoreVertIcon />}>
                                        {proyecto.id !== proyecto_formulario_10_linea_69_to_destroy ? (
                                            <div>
                                                ...
                                                <MenuItem>
                                                    <a href={route(`convocatorias.proyectos.pdf-formulario10-linea69`, [convocatoria.id, proyecto.id])} target="_blank" className="flex items-center">
                                                        PDF del proyecto
                                                    </a>
                                                </MenuItem>
