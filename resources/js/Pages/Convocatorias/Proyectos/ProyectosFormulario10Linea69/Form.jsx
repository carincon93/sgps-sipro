...
const Form = ({ is_super_admin, auth_user, method = '', convocatoria, proyecto_formulario_10_linea_69, nodos_tecnoparque, roles_sennova, evaluacion, ...props }) => {
    const form = useForm({
        ...
        nodo_tecnoparque_id: proyecto_formulario_10_linea_69?.nodo_tecnoparque_id ?? '',
