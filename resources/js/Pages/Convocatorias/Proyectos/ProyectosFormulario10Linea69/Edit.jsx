...
const Edit = ({ auth, convocatoria, proyecto_formulario_10_linea_69, evaluacion, hubs_innovacion, centros_formacion, roles_sennova }) => {
    ...
    return (
        <AuthenticatedLayout>
            <Head title={proyecto_formulario_10_linea_69.titulo} />

            <Grid item md={12} className="!mb-20">
                <StepperMui auth_user={auth_user} convocatoria={convocatoria} proyecto={proyecto_formulario_10_linea_69?.proyecto} evaluacion={evaluacion} />
            </Grid>
