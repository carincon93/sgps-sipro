                ...
                <div>
                    ...
                    <AlertMui severity={form.data.clausula_confidencialidad ? 'success' : 'error'}>
                        ...
                        <Checkbox
                            ...
                            disabled={evaluacion_proyecto_formulario8_linea66.evaluacion.finalizado}
                ...
                dialogContent={
                    <form onSubmit={submitEvaluacionRol} id="test">
                        ...
                        <div className="mt-6 flex items-center justify-end">
                            ...
                            <PrimaryButton disabled={form_evaluacion_rol.processing || evaluacion_proyecto_formulario8_linea66.evaluacion.finalizado} type="submit">
                                Guardar
                            </PrimaryButton>
                        </div>
                    </form>
                ...
                dialogContent={
                    <form onSubmit={submitEvaluacionRubro} id="test">
                        ...
                        <div className="mt-6 flex items-center justify-end">
                            ...
                            <PrimaryButton disabled={form_evaluacion_rubro.processing || evaluacion_proyecto_formulario8_linea66.evaluacion.finalizado} type="submit">
                                Guardar
                            </PrimaryButton>
                        </div>
                    </form>
