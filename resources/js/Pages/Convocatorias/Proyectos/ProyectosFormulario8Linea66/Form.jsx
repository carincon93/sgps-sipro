            ...
            <Grid container rowSpacing={20}>
                ...
                <Grid item md={6}>
                    {method == 'POST' ? (
                        <Autocomplete
                            ...
                            options={
                                centros_formacion ?? [{ value: proyecto_formulario_8_linea_66.proyecto.centro_formacion.id, label: proyecto_formulario_8_linea_66.proyecto.centro_formacion.nombre }]
                            }
                ...
                {method == 'PUT' && (
                    <>
                        ...
                        {form.data.relacionado_mesas_sectoriales == 1 && (is_super_admin || proyecto_formulario_8_linea_66?.proyecto.allowed.to_update) && (
                            <>
                                <Grid item md={6}>
                        ...
                        {form.data.relacionado_tecnoacademia == 1 && (is_super_admin || proyecto_formulario_8_linea_66?.proyecto.allowed.to_update) && (
                            <>
                                <Grid item md={6}>
