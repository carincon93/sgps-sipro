...
const Evaluacion = ({ convocatoria, evaluacion, allowed, proyecto, setDialogEvaluacionStatus, ...props }) => {
    const evaluacion_proyecto_formulario5_linea69 = evaluacion.evaluacion_proyecto_formulario5_linea69 ?? evaluacion

    const form = useForm({
        evaluacion_id: evaluacion?.id,
        clausula_confidencialidad: evaluacion?.clausula_confidencialidad ?? evaluacion?.evaluacion?.clausula_confidencialidad,

        resumen_regional_comentario: evaluacion_proyecto_formulario5_linea69?.resumen_regional_comentario ? evaluacion_proyecto_formulario5_linea69?.resumen_regional_comentario : '',
        resumen_regional_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.resumen_regional_comentario == null ? true : false,

        antecedentes_regional_comentario: evaluacion_proyecto_formulario5_linea69?.antecedentes_regional_comentario ? evaluacion_proyecto_formulario5_linea69?.antecedentes_regional_comentario : '',
        antecedentes_regional_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.antecedentes_regional_comentario == null ? true : false,
        municipios_comentario: evaluacion_proyecto_formulario5_linea69?.municipios_comentario ? evaluacion_proyecto_formulario5_linea69?.municipios_comentario : '',
        municipios_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.municipios_comentario == null ? true : false,
        fecha_ejecucion_comentario: evaluacion_proyecto_formulario5_linea69?.fecha_ejecucion_comentario ? evaluacion_proyecto_formulario5_linea69?.fecha_ejecucion_comentario : '',
        fecha_ejecucion_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.fecha_ejecucion_comentario == null ? true : false,
        cadena_valor_comentario: evaluacion_proyecto_formulario5_linea69?.cadena_valor_comentario ? evaluacion_proyecto_formulario5_linea69?.cadena_valor_comentario : '',
        cadena_valor_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.cadena_valor_comentario == null ? true : false,
        impacto_centro_formacion_comentario: evaluacion_proyecto_formulario5_linea69?.impacto_centro_formacion_comentario
            ? evaluacion_proyecto_formulario5_linea69?.impacto_centro_formacion_comentario
            : '',
        impacto_centro_formacion_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.impacto_centro_formacion_comentario == null ? true : false,
        bibliografia_comentario: evaluacion_proyecto_formulario5_linea69?.bibliografia_comentario ? evaluacion_proyecto_formulario5_linea69?.bibliografia_comentario : '',
        bibliografia_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.bibliografia_comentario == null ? true : false,
        retos_oportunidades_comentario: evaluacion_proyecto_formulario5_linea69?.retos_oportunidades_comentario ? evaluacion_proyecto_formulario5_linea69?.retos_oportunidades_comentario : '',
        retos_oportunidades_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.retos_oportunidades_comentario == null ? true : false,
        pertinencia_territorio_comentario: evaluacion_proyecto_formulario5_linea69?.pertinencia_territorio_comentario ? evaluacion_proyecto_formulario5_linea69?.pertinencia_territorio_comentario : '',
        pertinencia_territorio_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.pertinencia_territorio_comentario == null ? true : false,
        metodologia_comentario: evaluacion_proyecto_formulario5_linea69?.metodologia_comentario ? evaluacion_proyecto_formulario5_linea69?.metodologia_comentario : '',
        metodologia_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.metodologia_comentario == null ? true : false,
        analisis_riesgos_comentario: evaluacion_proyecto_formulario5_linea69?.analisis_riesgos_comentario ? evaluacion_proyecto_formulario5_linea69?.analisis_riesgos_comentario : '',
        analisis_riesgos_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.analisis_riesgos_comentario == null ? true : false,
        anexos_comentario: evaluacion_proyecto_formulario5_linea69?.anexos_comentario ? evaluacion_proyecto_formulario5_linea69?.anexos_comentario : '',
        anexos_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.anexos_comentario == null ? true : false,
        productos_comentario: evaluacion_proyecto_formulario5_linea69?.productos_comentario ? evaluacion_proyecto_formulario5_linea69?.productos_comentario : '',
        productos_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.productos_comentario == null ? true : false,
        arbol_problemas_comentario: evaluacion_proyecto_formulario5_linea69?.arbol_problemas_comentario ? evaluacion_proyecto_formulario5_linea69?.arbol_problemas_comentario : '',
        arbol_problemas_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.arbol_problemas_comentario == null ? true : false,
        arbol_objetivos_comentario: evaluacion_proyecto_formulario5_linea69?.arbol_objetivos_comentario ? evaluacion_proyecto_formulario5_linea69?.arbol_objetivos_comentario : '',
        arbol_objetivos_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.arbol_objetivos_comentario == null ? true : false,
        articulacion_sennova_comentario: evaluacion_proyecto_formulario5_linea69?.articulacion_sennova_comentario ? evaluacion_proyecto_formulario5_linea69?.articulacion_sennova_comentario : '',
        articulacion_sennova_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.articulacion_sennova_comentario == null ? true : false,
        proyecto_presupuesto_comentario: evaluacion_proyecto_formulario5_linea69?.proyecto_presupuesto_comentario ? evaluacion_proyecto_formulario5_linea69?.proyecto_presupuesto_comentario : '',
        proyecto_presupuesto_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.proyecto_presupuesto_comentario == null ? true : false,
        ortografia_comentario: evaluacion_proyecto_formulario5_linea69?.ortografia_comentario ? evaluacion_proyecto_formulario5_linea69?.ortografia_comentario : '',
        ortografia_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.ortografia_comentario == null ? true : false,
        redaccion_comentario: evaluacion_proyecto_formulario5_linea69?.redaccion_comentario ? evaluacion_proyecto_formulario5_linea69?.redaccion_comentario : '',
        redaccion_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.redaccion_comentario == null ? true : false,
        normas_apa_comentario: evaluacion_proyecto_formulario5_linea69?.normas_apa_comentario ? evaluacion_proyecto_formulario5_linea69?.normas_apa_comentario : '',
        normas_apa_requiere_comentario: evaluacion_proyecto_formulario5_linea69?.normas_apa_comentario == null ? true : false,
    })
    ...
    const submit = (e) => {
        ...
        if (allowed.to_update) {
            form.put(route('convocatorias.evaluaciones-formulario-5-linea-69.update', [convocatoria.id, evaluacion.id]), {
    ...
    return (
        <>
            <form onSubmit={submit} className="space-y-10" id="form-evaluacion">
                <div>
                    ...
                    <AlertMui severity={form.data.clausula_confidencialidad ? 'success' : 'error'}>
                        ...
                        <Checkbox
                            ...
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                ...
                <div>
                    <Divider className="!my-20 font-black">antecedentes_regional_comentario</Divider>

                    <div className="mt-10">
                        <p>
                            ¿El antecedentes_regional_comentario es correcto? Si considera que la información puede mejorarse, por favor seleccione <strong>NO</strong> y haga la respectiva
                            recomendación.
                        </p>
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.antecedentes_regional_requiere_comentario}
                            onChange={(e) => form.setData('antecedentes_regional_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                        {form.data.antecedentes_regional_requiere_comentario == false && (
                            <Textarea
                                label="Comentario"
                                className="mt-4"
                                inputBackground="#fff"
                                id="antecedentes_regional_comentario"
                                value={form.data.antecedentes_regional_comentario}
                                error={form.errors.antecedentes_regional_comentario}
                                onChange={(e) => form.setData('antecedentes_regional_comentario', e.target.value)}
                                disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                                required
                            />
                        )}
                ...
                <div>
                    ...
                    <div className="mt-10">
                        ...
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.municipios_requiere_comentario}
                            onChange={(e) => form.setData('municipios_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                ...
                <div>
                    ...
                    <div className="mt-10">
                        ...
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.fecha_ejecucion_requiere_comentario}
                            onChange={(e) => form.setData('fecha_ejecucion_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                ...
                <div>
                    <Divider className="!my-20 font-black">pertinencia_territorio_comentario</Divider>

                    <div className="mt-10">
                        <p>
                            ¿El pertinencia_territorio_comentario es correcto? Si considera que la información puede mejorarse, por favor seleccione <strong>NO</strong> y haga la respectiva
                            recomendación.
                        </p>
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.pertinencia_territorio_requiere_comentario}
                            onChange={(e) => form.setData('pertinencia_territorio_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                        {form.data.pertinencia_territorio_requiere_comentario == false && (
                            <Textarea
                                label="Comentario"
                                className="mt-4"
                                inputBackground="#fff"
                                id="pertinencia_territorio_comentario"
                                value={form.data.pertinencia_territorio_comentario}
                                error={form.errors.pertinencia_territorio_comentario}
                                onChange={(e) => form.setData('pertinencia_territorio_comentario', e.target.value)}
                                disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                                required
                            />
                        )}
                ...
                <div>
                    ...
                    <div className="mt-10">
                        ...
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.anexos_requiere_comentario}
                            onChange={(e) => form.setData('anexos_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                ...
                <div>
                    <Divider className="!my-20 font-black">arbol_problemas_comentario</Divider>
                    ...
                    <div className="mt-10">
                        ...
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.arbol_problemas_requiere_comentario}
                            onChange={(e) => form.setData('arbol_problemas_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                ...
                <div>
                    ...
                    <div className="mt-10">
                        ...
                        <SwitchMui
                            className="!my-6"
                            checked={form.data.arbol_objetivos_requiere_comentario}
                            onChange={(e) => form.setData('arbol_objetivos_requiere_comentario', e.target.checked)}
                            disabled={evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado}
                        />
                ...
                dialogContent={
                    <form onSubmit={submitEvaluacionRol} id="test">
                        ...
                        <div className="mt-6 flex items-center justify-end">
                            ...
                            <PrimaryButton disabled={form_evaluacion_rol.processing || evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado} type="submit">
                                Guardar
                            </PrimaryButton>
                        </div>
                    </form>
                ...
                dialogContent={
                    <form onSubmit={submitEvaluacionRubro} id="test">
                        ...
                        <div className="mt-6 flex items-center justify-end">
                            ...
                            <PrimaryButton disabled={form_evaluacion_rubro.processing || evaluacion_proyecto_formulario5_linea69.evaluacion.finalizado} type="submit">
                                Guardar
                            </PrimaryButton>
                        </div>
                    </form>
