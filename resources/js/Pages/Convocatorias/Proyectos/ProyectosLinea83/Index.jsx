...
const Index = ({ auth, convocatoria, proyectos_linea_83, allowed_to_create }) => {
        ...
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Líneas programáticas</h2>}>
            <Grid container>
                {checkRole(auth_user, [1, 20, 18, 19, 5, 17]) && (
                    <Grid item md={12}>
                        <TabsConvocatoria value="0" convocatoria={convocatoria} linea_programatica_id="11" />
                    </Grid>
                )}
                ...
                <Grid item md={12}>
                    ...
                    <TableMui rows={['Título', 'Fecha de ejecución', 'Estado (Evaluación)', 'Acciones']} sxCellThead={{ width: '320px' }}>
                        ...
                        {proyectos_linea_83.data.map(({ id, proyecto, titulo, fecha_ejecucion }) => (
                            <TableRow key={id}>
                                <TableCell>
                                    <div>
                    ...
                    <PaginationMui links={proyectos_linea_83.links} />
                </Grid>
            </Grid>
        </AuthenticatedLayout>
    )
