        ...
        <tbody slot="tbody">
            {#each gruposInvestigacionCentroFormacion as grupoInvestigacion (grupoInvestigacion.id)}
                <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                    <td class="border-t">
                        <p class="px-6 py-4 focus:text-app-500 first-letter-uppercase">
                ...
                <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                    ...
                    <td class="border-t td-actions">
                        <DataTableMenu class={gruposInvestigacion.data.length < 3 ? 'z-50' : ''}>
                            ...
                            <Separator class={!grupoInvestigacion.allowed.to_destroy ? 'hidden' : ''} />
                            <Item on:SMUI:action={() => ((grupoInvestigacionId = grupoInvestigacion.id), (dialogEliminar = true), (allowedToDestroy = grupoInvestigacion.allowed.to_destroy))} disabled={!grupoInvestigacion.allowed.to_destroy} class={!grupoInvestigacion.allowed.to_destroy ? 'hidden' : ''}>
