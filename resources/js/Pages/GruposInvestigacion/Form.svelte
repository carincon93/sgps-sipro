...
<form on:submit|preventDefault={submit} class="bg-white rounded shadow" id="grupo-investigacion-form">
    <fieldset class="p-8" disabled={grupoInvestigacion?.allowed.to_update || allowedToCreate ? undefined : true}>
        <div class="mt-8">
        ...
        <div class="mt-8">
            <Label class="mb-4 mt-8" labelFor="formato_gic_f_020" value="Formato GIC – F – 021" />
...
<Dialog bind:open={dialogGuardar}>
    ...
    <div slot="content">
        <Export2Word id="borrador" showButton={false} bind:this={exportComponent}>
            <h1 class="font-black text-center my-10">Información del grupo de investigación</h1>
    ...
    <div slot="actions">
        <div class="p-4">
            ...
            {#if grupoInvestigacion?.allowed.to_update || allowedToCreate}
                <LoadingButton loading={$form.processing} form="grupo-investigacion-form">Guardar</LoadingButton>
            {:else}
