...
<AuthenticatedLayout>
        ...
        <div className="flex items-center justify-between lg:px-8 max-w-7xl mx-auto px-4 py-6 sm:px-6">
            <div>
                <h1 className="overflow-ellipsis overflow-hidden w-breadcrumb-ellipsis whitespace-nowrap">
                    <a use:inertia href={route('lineas-programaticas.index')} className="text-app-400 hover:text-app-600"> Líneas programáticas </a>
    ...
    <div className="grid grid-cols-3 gap-4">
        <div className="sticky top-0">
            <h1 className="font-black text-4xl uppercase">Editar línea programática</h1>
        </div>

        <div className="bg-white rounded shadow col-span-2">
            <Form {errors} {is_super_admin} {categoriasProyectos} {activadores} {form} {lineaProgramatica} {submit} />
        </div>
    </div>
</AuthenticatedLayout>
