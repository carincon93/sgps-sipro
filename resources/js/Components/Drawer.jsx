                    ...
                    <ListItem disablePadding sx={{ display: 'block' }}>
                        ...
                        {checkRole(user, [1, 5, 11, 17, 18, 19, 33]) && (
                            <ListItemButton
                                ...
                                onClick={() => router.visit(route('evaluaciones.index'))}>
                                <ListItemIcon
                                    sx={{
                                        minWidth: 0,
                                        mr: open ? 3 : 'auto',
                        ...
                        {checkRole(user, [1, 5, 17, 18, 19]) && (
                            <ListItemButton
                                ...
                                onClick={() => router.visit(route('ambientes-modernizacion.index'))}>
                                <ListItemIcon
                                    sx={{
                                        minWidth: 0,
                                        mr: open ? 3 : 'auto',
                                ...
                                <ListItemText primary="Ambientes de modernización" sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        )}
                        ...
                        {checkRole(user, [1, 5, 17, 18, 19]) && (
                            <ListItemButton
                                ...
                                onClick={() => router.visit(route('anexos.index'))}>
                                <ListItemIcon
                                    sx={{
                                        minWidth: 0,
                                        mr: open ? 3 : 'auto',
                                ...
                                <ListItemText primary="Anexos" sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        )}
                        ...
                        <ListItemButton
                            ...
                            onClick={() => router.visit(route('semilleros-investigacion.nivel-nacional'))}>
                            <ListItemIcon
                                sx={{
                                    minWidth: 0,
                                    mr: open ? 3 : 'auto',
                            ...
                            <ListItemText primary="Semilleros de investigación" sx={{ opacity: open ? 1 : 0 }} />
                        </ListItemButton>
