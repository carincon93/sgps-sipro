...
<body>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="3" style="font-size: 12px;">
        ...
        <tr>
            ...
            <td align="left">
                <p style="white-space: pre-wrap">Aplica para todas las áreas de conocimiento</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <p style="white-space: pre-wrap">Aplica para todas las actividades económicas</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <p style="white-space: pre-wrap">Aplica para todas las temáticas estratégicas SEN</p>
            </td>
        </tr>
