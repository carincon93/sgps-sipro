...
<body>
    ...
    <h4>Contexto General de la Red Tecnoparques</h4>
    ...
    <h4>Descripción de retos y prioridades locales y regionales identificadas para ser atendidas por el Tecnoparque a corto (vigencia {{ $convocatoria->year }}), mediano y largo plazo</h4>
    <p style="white-space: pre-wrap">{{ $datos->retos_locales_regionales }}</p>

    <h4>De acuerdo al IDIC (Indice Departamental de Innovación para Colombia https://AplicativoIDIC2020.ocyt.org.co/), identifique el estado actual del Departamento y plantee acciones que puedan ser ejecutadas por el Tecnoparque en la vigencia {{ $convocatoria->year }} para contribuir con el mejoramiento del estado actual</h4>
    <p style="white-space: pre-wrap">{{ $datos->estado_actual_departamento }}</p>

    <h4>¿Cómo el Tecnoparque, contribuirá en la vigencia ${convocatoria.year} al desarrollo y fortalecimiento de las capacidades tecnológicas de las empresas, cadenas productivas y clústeres de la región</h4>
    <p style="white-space: pre-wrap">{{ $datos->contribucion_desarrollo_empresas }}</p>

    <h4>¿Cómo se articuló en el año {{ $convocatoria->year - 1 }} y cual será la contribución del Tecnoparque con la Agenda de la Comisión Regional de Competitividad, en la vigencia {{ $convocatoria->year }}?</h4>
    ...
    <h4>¿Cuáles serán los aportes del Tecnoparque de Innovación en el {{ $convocatoria->year }} a la Línea de acción 8 del Conpes 4011 'Facilitar intercambio de tecnología y la innovación en los emprendimientos CONPES, inlcuyendo acciones articuladas con Emprendimiento (Dirección de Empleo)?</h4>
    <p style="white-space: pre-wrap">{{ $datos->aportes_conpes_4011 }}</p>

    <h4>¿Cuáles serán los aportes del Tecnoparque de Innovación en el {{ $convocatoria->year }} a la Línea de acción 1 del Conpes 4080 'el SENA desde 2022 y hasta 2026, fomentará la participación de la mujer en sus programas de investigación, desarrollo tecnológico e innovación, buscando generar competitividad con enfoque de género?</h4>
    ...
    <h4>Describa las oportunidades en el departamento y regiones de influencia del Tecnoparque de Innovación para contribuir con la fortalecer proyectos de I + D + i tendientes a aportar alternativas de generación eléctrica a partir de fuentes no convencionales de energía renovable</h4>
    <p style="white-space: pre-wrap">{{ $datos->aportes_alternativas_generacion_electrica }}</p>

    <h4>Describa las oportunidades en el departamento y regiones de influencia del Tecnoparque de Innovación para contribuir con el impulso de la Economía Popular. Proyectos tendientes a aumentar los ingresos de los micronegocios de la economía popular</h4>
    <p style="white-space: pre-wrap">{{ $datos->aportes_impulso_economia_popular }}</p>

    <h4>Justificación y pertinencia de las acciones que desarrolla el Tecnoparque en el territorio</h4>
    <p style="white-space: pre-wrap">{{ $datos->justificacion_pertinencia }}</p>

    <h4>Describa las acciones realizadas en el {{ $convocatoria->year - 1 }}, integradas dentro de la Estrategia Campesena, en las que participó el Tecnoparque</h4>
    ...
    <h4>¿Cuales fueron las principales acciones ejecutadas por el Tecnoparque en la vigencia {{ $convocatoria->year - 1 }} para contribuir a la formación en el Centro y en la Regional?</h4>
    <p style="white-space: pre-wrap">{{ $datos->contribucion_formacion_centro_regional }}</p>

    <h4>Para la vigencia {{ $convocatoria->year }}, defina acciones a realizar desde el Tecnoparque, que sean verificables, y que contribuyan al fortalecimiento de la formación en el Centro y en la regional</h4>
    <p style="white-space: pre-wrap">{{ $datos->acciones_fortalecimiento_centro_regional }}</p>

    <h4>Defina acciones a realizar en el {{ $convocatoria->year }}, que promuevan la participación de aprendices en el Tecnoparque</h4>
    <p style="white-space: pre-wrap">{{ $datos->acciones_participacion_aprendices }}</p>

    <h4>A partir de las acciones realizadas en el {{ $convocatoria->year - 1 }}, desde la oferta de Formación Complementaria (EDTs y otros Eventos), proyecte las acciones a realizar en la vigencia {{ $convocatoria->year }} en las que participe el Tecnoparque</h4>
    ...
    <h4>Describa los Proyectos de Investigación del Centro en la vigencia {{ $convocatoria->year - 1 }}, en los cuales participó el Tecnoparque. Plantee oportunidades para el fortalecimiento de esta articulación</h4>
    ...
    <h1>El Tecnoparque en el Eje de Servicios de I+D+i</h1>

    <h4>A partir de los resultados y las acciones realizadas por el Tecnoparque, ¿Cómo proyecta la articulación en el {{ $convocatoria->year - 1 }}, el con la línea de Servicios Tecnológicos?</h4>
    <p style="white-space: pre-wrap">{{ $datos->proyeccion_articulacion_linea_68 }}</p>

    <h4>A partir de los resultados y las acciones realizadas por el Tecnoparque, ¿Cómo proyecta la articulación en el {{ $convocatoria->year - 1 }}, el con la línea de Extensionismo Tecnológico?</h4>
    <p style="white-space: pre-wrap">{{ $datos->proyeccion_articulacion_linea_83 }}</p>

    <h4>A partir de los resultados y las acciones realizadas por el Tecnoparque en las convocatorias de Fomento a la Innovación, plantee oportunidades para el fortalecimietno de esta estrategia {{ $convocatoria->year }} para ser implementadas en la siguiente vigencia</h4>
    ...
    <h1>Metodología General implementada por el Tecnoparque</h1>
    <p style="white-space: pre-wrap">{{ $datos->metodologia }}</p>

    @if ($datos->metodologia_local)
    <h2>A continuación, describa la metodología que será implementada en el {{ $convocatoria->year }} en el nodo para lograr los objetivos propuestos en cada una de las etapas definidas para los Tecnoparques:</h2>
    ...
    <h2>Describa las acciones que serán realizadas en el {{ $convocatoria->year }} para cotriuir al mejoramiento del IDIC del Departamento, desde el Tecnoparque</h2>
    ...
    <h2>Número de Empresas atendidas en el {{ $convocatoria->year - 1 }}, por el Tecnoparque</h2>
    ...
    <h2>Comparta las alianzas estratégicas a gestionar en el {{ $convocatoria->year }} para promover el logro de las metas del Tecnoparque</h2>
    <p style="white-space: pre-wrap">{{ $datos->gestion_alianzas_estrategicas }}</p>
    @endif

    @if ($datos->estrategias_visibilizacion)
    <h2>Comparta la estrategia de divulgación y visibilización de acciones del Tecnoparque para el {{ $convocatoria->year }}</h2>
    <p style="white-space: pre-wrap">{{ $datos->estrategias_visibilizacion }}</p>
    @endif

    @if ($datos->integracion_plan_tecnologico)
    <h2>¿Cómo está integrado el Tecnoparque en el Plan Tecnológico del Centro?</h2>
    ...
    <h2>Proponga las estrategias para el {{ $convocatoria->year - 1 }} con el fin de que el Tecnoparque contribuya desde la ciencia, la Tecnología e Innovación a promover la productividad e innovación agropecuaria y agroindustrial en los territorios que impacta el Tecnoparque</h2>
    <p style="white-space: pre-wrap">{{ $datos->estrategias_productividad_agropecuaria }}</p>
    @endif

    @if ($datos->acciones_estrategia_campesena)
    <h2>A partir de las necesidades y retos territoriales, plantee cuales serán las acciones a realizar en el {{ $convocatoria->year }}, integradas dentro de la Estrategia Campesena, en las que participará el Tecnoparque</h2>
    <p style="white-space: pre-wrap">{{ $datos->acciones_estrategia_campesena }}</p>
    @endif

    @if ($datos->estrategia_campesena_campesinos)
    <h2>Describa las acciones del Tecnoparque a realizar en el {{ $convocatoria->year }}, que estarán integradas dentro de la Estrategia Campesena, para beneficiar Campesinos y agremiaciones campesinas y especialmente al acompañamiento de Proyectos de I + D + i tendientes a generar y articular mecanismos de atención diferencial, integral e incluyente, para los campesinos, de acuerdo con sus particularidades sociales, culturales, económicas y territoriales, que faciliten el acceso a los programas de formación y demás servicios de la Entidad</h2>
    <p style="white-space: pre-wrap">{{ $datos->estrategia_campesena_campesinos }}</p>
    @endif

    @if ($datos->acciones_fortalecimiento_economia_popular)
    <h2>Describa las acciones del Tecnoparque a realizar en el {{ $convocatoria->year }}, que estarán direccionadas a fortalecer la Economía Popular</h2>
    <p style="white-space: pre-wrap">{{ $datos->acciones_fortalecimiento_economia_popular }}</p>
    @endif

    @if ($datos->acciones_fortalecimiento_idi)
    <h2>Describa las acciones del Tecnoparque a realizar en el ${convocatoria.year}, que estarán direccionadas a fortalecer Proyectos de I + D + i tendientes generación eléctrica a partir de fuentes no convencionales de energía renovable</h2>
